...
keywords:
  ...
  - IP Box Polska IT
  - ulgi sp z o o
  - optymalizacja podatkowa Polska
relatedServices:
...
# Ulgi podatkowe dla biznesu w Polsce 2026: Estoński CIT, 9% CIT i IP Box
...
1. wszyscy udziałowcy to osoby fizyczne;
2. przychody pasywne (odsetki, należności licencyjne, najem) ≤ 50 % obrotu;
3. min. 3 pracownicy na umowie o pracę (lub 4 dla małego podatnika);
4. brak handlu udziałami innych spółek;
5. ZAW-RD złożone do końca pierwszego miesiąca roku obrotowego.
...
1. Stworzenie lub istotna modyfikacja kwalifikowanego prawa IP.
2. Dochód z komercjalizacji ewidencjonowany odrębnie.
3. Wydatki na R&D powiązane - udokumentowane.
4. Załącznik PIT/IP lub CIT/IP do rocznej deklaracji.
...
[Umów konsultację podatkową →](/pl/uslugi/podatki-ksiegowosc)
...
- [Zwrot podatku 2026: PIT-37 dla cudzoziemców](/pl/blog/vozvrat-nalogov-pit-37-pit-11-inostrancam)
