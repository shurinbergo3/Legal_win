...
keywords:
  - karta pobytu employer
  - karta pobytu praca attached
  - changing employer karta pobytu
  - zezwolenie na pobyt czasowy praca
  - powiadomienie change of employer
relatedServices:
...
|---|---|---|
| Karta czasowego pobytu (praca) | **Yes** | Pracodawca, position, salary all named |
| Karta Błękitna UE | Partial | Tied for first 2 years, free thereafter |
| Karta CUKR (UA) | No | Work for any employer permitted |
| Karta czasowego pobytu (rodzina) | No | No work restrictions |
| Karta czasowego pobytu (działalność) | No | You are your own employer |
...
## What DOES Require Notification
...
5. **Termination of the employment contract** without immediate transition to new work

In each of these cases you have **15 working days** to notify the voivode. After 15 days, the risk is high that the new employer cannot legally hire you and that the karta pobytu will be annulled.
...
- Scan of the current karta pobytu (both sides)
- Umowa o pracę or zlecenie with the new employer (salary at or above 4,806 PLN gross)
- Załącznik nr 1 from the new employer (questionnaire signed via the employer's Profil Zaufany)
- Zaświadczenie from ZUS confirming registration (issued in 1 day)

**Step 2. Filing in MOS v2.0.** Login via your Profil Zaufany. In the section "Sprawy bieżące" → "Powiadomienie o zmianie pracodawcy". Fill in the data of the old and new employer, attach scans.
...
Seven years of Warsaw client work surfaces the same failures:
...
If your contract has ended and there is no new work in place:

**Option 1. You have 15 working days** to find a new employer and file the powiadomienie. If nothing is found in that time, the voivode is entitled to start an annulment procedure for the karta pobytu.

**Option 2. Apply for a new karta on different grounds.** If there is no new job in 15 days but there is a different basis (marriage to a resident, JDG registration, university enrolment), you can file a new karta pobytu on that basis. The old one is annulled, the new one is issued via MOS v2.0.
...
If the voivode has nonetheless begun the annulment procedure (formal letter "zawiadomienie o wszczęciu postępowania w sprawie unieważnienia decyzji"), you have:

- **7 days to respond** via eDoręczenia, with a justification for why the card should not be annulled
...
## Realistic Timeline for an Employer Change
...
- The new employer has experience hiring foreigners
- The karta pobytu has no complicated history
- Załącznik nr 1 is filled without errors
- You are within the 15-day deadline

A lawyer is essential if:

- You have a prior annulment or returned application
- The new employer is hiring a foreigner for the first time
- You are changing both position and employer simultaneously
