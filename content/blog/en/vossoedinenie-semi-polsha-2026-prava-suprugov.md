...
keywords:
  - family reunification Poland 2026
  - połączenie z rodziną
  - spouse karta pobytu work
...
- the family's karta pobytu duration tracks the sponsor's.

A "family member" in this regime means:

- spouse in a registered marriage;
- the sponsor's minor children (biological or adopted), including the spouse's;
- adult children up to 25 in full-time study and financially dependent on the sponsor;
- the sponsor's parents, if the sponsor is a minor without a legal guardian in Poland.

Note: same-sex partnerships are not recognised in Poland, nor is de facto cohabitation. Only a marriage certificate recognised in Poland qualifies.

## Who Gets Automatic "Dostęp do Rynku Pracy"
...
| Sponsor's status | Spouse's annotation |
|---|---|
| Karta stałego pobytu | dostęp do rynku pracy |
| EU long-term resident | dostęp do rynku pracy |
| EU Blue Card | dostęp do rynku pracy + accelerated reunification |
| Karta CUKR | dostęp do rynku pracy |
| Polish citizenship | special right of stay + full work rights |
| Karta czasowego pobytu (work, business) | **no annotation**, oświadczenie or zezwolenie required |
| Student karta czasowego pobytu | no annotation |

In 2026 the Blue Card 2.0 reform tightened the rule further: spouses receive the annotation **on the day** the card is issued, without the previous 12-month wait.
...
Path depends on where the spouse is.

**Spouse already in Poland** (on a D visa, visa-free, or another karta):
...
1. Sponsor files a "wniosek o wydanie zaproszenia" with the voivode (a special reunification form, distinct from electronic invitations for visas).
...
Self-handling works if: sponsor already has karta stałego or Blue Card, income above 8,000 PLN gross, marriage certificate apostilled, only Polish-born children.
...
This article is informational. The route depends on the sponsor's status, country of marriage, and family composition. For individual matters, please consult a lawyer.
...
- Service: [family reunification and spousal karta pobytu](/en/uslugi/karta-pobytu)
