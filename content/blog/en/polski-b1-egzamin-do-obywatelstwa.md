...
keywords:
  ...
  - Polish for citizenship
  - Państwowa Komisja Polish certification
  - Polish B1 preparation
relatedServices:
...
| Item | 2026 price |
|---|---|
| Exam registration | EUR 150 (~PLN 640) |
| Resit (after a fail) | Full EUR 150 |
| Written certificate copy | PLN 60 (with MSZ apostille - +PLN 60) |
| Express issuance | +50% |
...
| Starting level | Hours to B1 |
|---|---|
| Never studied Polish (knows Russian/Ukrainian) | 200-300 hrs (6-9 months at 1-2 h/day) |
| Basic A1 after a year in Poland without classes | 150-200 hrs |
| A2 after courses or Karta Polaka | 80-120 hrs |
...
For preparation and exam booking, LegalWin offers a [partner course](/en/uslugi/obywatelstwo) with qualified tutors - 80% of our clients pass B1 on the first attempt. [Get in touch](/en/uslugi/obywatelstwo) - we'll handle preparation and the citizenship application end-to-end.

**Related articles:**
- [Karta Polaka - how to get it](/en/blog/karta-polaka-kak-poluchit)
- [Karta Stałego Pobytu (PR) Poland 2026](/en/blog/karta-stalego-pobytu-pmzh-polsha-2026)
- [Marriage to a Polish citizen - registration](/en/blog/brak-s-polyakom-registratsiya)
- Service: [Polish citizenship](/en/uslugi/obywatelstwo)
