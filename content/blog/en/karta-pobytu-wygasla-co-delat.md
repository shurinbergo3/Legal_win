...
keywords:
  - residence card expired Poland
  - karta pobytu wygasła
  - expired residence permit Poland 2026
  - Polish residence card overstay
  - deportation expired card Poland
  - new MOS v2.0 application after expiry
relatedServices:
...
# Polish residence card expired - what to do in 2026
...
1. File a fresh residence-card application in MOS v2.0 in "urgent grounds" mode. In the justification (uzasadnienie) explain the cause of the delay (illness, lost documents, employer delay with the work permit).
2. In parallel, book a biometrics slot at the voivode (queue: 2-6 weeks).
3. Do not leave Poland. Any border crossing = an unlawful-stay stamp + an entry ban.
...
1. File the residence-card application **immediately**, even with low odds. Filing suspends deportation under Article 305(1) of the Foreigners Act.
2. If you've received a return order - you have 14 days to appeal to the Head of UdSC. The deadline is strict.
3. Gather evidence of your centre of vital interests in Poland: lease contracts, ZUS, tax authority, children in school, bank accounts. This often becomes grounds for humanitarian residence.
4. Don't leave on your own - voluntary departure with an expired card = unlawful-stay stamp at the border and an automatic entry ban.
...
1. Check the expiry date on the card - don't confuse it with the passport or visa expiry.
2. Open MOS v2.0 and check whether an application has already been filed (sometimes the employer files without your involvement).
3. Today - start gathering documents for the new application.
4. Don't leave Poland until the matter is resolved.
5. [Contact LegalWin](/en/uslugi/karta-pobytu) - emergency filing within 24 hours, deportation-risk minimisation.
...
**Related articles:**
- [Polish residence card 2026: step-by-step guide](/en/blog/karta-pobytu-2026-poshagovaya-instrukciya)
- [What to do after a Karta Pobytu refusal](/en/blog/otkaz-po-karte-pobytu)
- [Service: Karta Czasowego Pobytu](/en/uslugi/karta-pobytu)
