...
keywords:
  - residence card Poland business 2026
  - JDG karta pobytu
  - Sp. z o.o. residence permit
  - own business basis Polish residence
  - 12x average wage Poland
relatedServices:
...
# Karta Pobytu on Business Grounds in Poland 2026: JDG vs Sp. z o.o.
...
| Tax form | Effective rate | When it makes sense |
|---|---|---|
| Skala podatkowa (general scale) | 12% to PLN 120,000, 32% above | When you have substantial expenses |
| Podatek liniowy (flat tax) | 19% | Income PLN 120-300k, low expenses |
| Ryczałt (lump sum) | 2-17% of turnover | Services with low expenses, IT, translations |
...
| Parameter | JDG | Sp. z o.o. |
|---|---|---|
| Setup | 1 day, free | 1-30 days, PLN 250-1,500 |
| Share capital | None required | PLN 5,000 minimum |
| Bookkeeping | KPiR (simplified) | Full bookkeeping (mandatory) |
| Liability | Personal, unlimited | Limited to share contribution |
| ZUS | Self-paid, ~PLN 1,750/month | Only if drawing a salary as employee |
| CIT | Does not pay; PIT under chosen form | 9% or 19% of profit |
| Dividends | None | 19% PIT |
| Karta pobytu complexity | Low - CEIDG + PIT | Medium - KRS + CIT-8 + employee list |
| Time from setup to karta filing | 1 day | 7-30 days |
| Minimum for karta pobytu | PLN 89,952 income/year | PLN 89,952/year or 2 employees |
...
| Sp. z o.o., 2+ employees | 12-18 months |
...
| Item | JDG | Sp. z o.o. |
|---|---|---|
| Business registration | PLN 0 | PLN 250-1,500 |
| Share capital | - | PLN 5,000 |
| Accounting (12 mo.) | PLN 3,600-6,000 | PLN 6,000-24,000 |
| ZUS (12 mo.) | PLN 12,000-21,000 | PLN 0 (without salary) |
| Stamp duty on the wniosek | PLN 340 | PLN 340 |
| Card blank | PLN 100 | PLN 100 |
| LegalWin handling | from PLN 3,000 | from PLN 4,500 |
| **Minimum total** | **PLN 18,040** | **PLN 15,440** |
...
[Book a business-grounds consultation →](/en/uslugi/karta-pobytu)
...
**Related material:**
- [Karta pobytu 2026: step-by-step guide](/en/blog/karta-pobytu-2026-poshagovaya-instrukciya)
- [JDG for foreigners in Poland](/en/blog/jdg-dlya-inostrancev-v-polshe)
- [Setting up a Sp. z o.o. in Poland](/en/blog/otkrytie-sp-z-o-o-polsha-instrukciya)
- Service: [karta czasowego pobytu](/en/uslugi/karta-pobytu)
- Service: [JDG registration](/en/uslugi/jdg)
- Service: [Sp. z o.o. registration](/en/uslugi/rejestracja-sp-z-oo)
