...
title: 'Convert JDG to sp. z o.o. 2026: When and How'
description: >-
  Przekształcenie JDG w spółkę z o.o. in 2026 - when to switch, the procedure,
  succession of rights and NIP, timing and cost, plus the new-company alternative.
locale: en
...
keywords:
  ...
  - convert sole proprietorship to company Poland
  - changing business form Poland
  - JDG succession spółka
  - move JDG to spółka
relatedServices:
...
# Converting a JDG into a sp. z o.o.: When It Is Time and How to Do It in 2026
...
1. **Plan przekształcenia** - the conversion plan, prepared by the entrepreneur.
2. **Badanie biegłego rewidenta** - in certain cases the plan is examined by a court-appointed sworn auditor.
3. **Oświadczenie o przekształceniu** and **akt notarialny** - the statement and the notarial deed, with adoption of the umowa spółki (articles of association).
4. **Wpis do KRS** - registration of the company in the register (Krajowy Rejestr Sądowy); from that moment the entrepreneur "becomes" the company.
5. **Updates** - data with the US (tax office), the bank, the CRBR (covered in our piece on [CRBR and the beneficial owner](/en/blog/crbr-beneficjent-rzeczywisty-2026)), and refreshed details with counterparties.
...
Changing form changes the tax regime too: the entrepreneur's PIT gives way to the company's CIT plus dividend tax at the shareholder level. That is a separate calculation - sometimes the tax advantage of a company structure (at high income, say) is exactly what pushes the conversion, and sometimes the smarter move is to stay on a JDG with a well-chosen tax form. We covered JDG taxation forms in the article on [JDG taxes in 2026](/en/blog/jdg-nalogi-2026-skala-liniowy-ryczalt). These numbers need to be run before a conversion, not changed "just in case".

If you are still choosing your starting form and the growth is not obvious, look at the comparison of [JDG or sp. z o.o.](/en/blog/jdg-ili-sp-z-oo-chto-vybrat-inostrancu-2026) - it may be simpler to open the company outright.
