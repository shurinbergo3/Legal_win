...
title: 'Polish Tax Residency 2026: The 183-Day Rule'
description: >-
  When a foreigner becomes a Polish tax resident, the role of CFR-1, how the
  double-taxation treaty works, why PIT-36 ZG matters for remote workers.
locale: en
...
| Parameter | Polish resident | Non-resident |
|---|---|---|
| What is declared | Worldwide income | Only Polish-source income |
| Form | PIT-36, PIT-37, PIT-36L | PIT-37 limited, PIT-36 limited |
| Tax on US salary | Yes, via PIT-36 + ZG attachment | No |
| Tax on Polish salary | Yes | Yes |
| Tax on foreign dividends | Yes, 19 % after the treaty | No |
| Crypto tax | Yes, 19 % on disposal | No, if not "Poland-linked" |
| Joint return with spouse | Yes, on conditions | No |
| Zero PIT for under-26 | Yes | No |
...
**Related materials:**
- [Tax refund in Poland: PIT-37 for foreigners step by step](/en/blog/vozvrat-nalogov-pit-37-pit-11-inostrancam)
- [Polish business tax incentives 2026: Estonian CIT, 9% CIT, IP Box](/en/blog/nalogovye-lgoty-estonian-cit-ip-box)
- Service: [tax & accounting for foreigners](/en/uslugi/podatki-ksiegowosc)
