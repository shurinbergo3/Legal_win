...
title: 'Karta Polaka 2026: Documents, Exam, Timelines'
description: >-
  How to obtain a Karta Polaka in 2026 - for people with Polish ancestry.
  Ancestry documents, language and culture exam, consulate, the privileges
  granted.
locale: en
...
keywords:
  - obtain Karta Polaka
  - Polish ancestry documents
  - Karta Polaka exam
  - polskie pochodzenie
  - Karta Polaka consulate
relatedServices:
  - /en/uslugi/karta-polaka
...
| Country | Main consulates |
|---|---|
| Belarus | Grodno, Brest, Minsk (since autumn 2023 - restrictions) |
| Ukraine | Lviv, Lutsk, Vinnytsia, Kharkiv, Odesa |
| Russia | Moscow, St. Petersburg, Kaliningrad (politically complicated) |
| Kazakhstan | Almaty |
| Lithuania | Vilnius |
...
## "Karta Polaka → Polish Passport" - The Fastest Legal Path

A legal route to a Polish passport in 2 years instead of the standard 9:

| Year | What you do |
|---|---|
| Year 1 | Obtain Karta Polaka via the consulate, move to Poland on a D visa |
| Year 2 | Receive karta stałego pobytu (free for KP holders) |
| Year 3 | Apply for uznanie obywatela polskiego via the voivode |
...
At LegalWin our [Karta Polaka service](/en/uslugi/karta-polaka) includes archive document searches, package preparation, and consulate accompaniment. From 2,800 PLN.

[Order Karta Polaka support →](/en/uslugi/karta-polaka#contact)
...
- Service: [Karta Polaka - preparation and accompaniment](/en/uslugi/karta-polaka)
