...
keywords:
  - PESEL UKR to karta pobytu
  - Ukrainian work card Poland
  - karta CUKR vs work karta
  - Ukrainian Poland 2026
  - 5 years EU resident
relatedServices:
...
| Status | Term | Right to work | Counts toward PR |
|---|---|---|---|
| PESEL UKR (temporary protection) | until 4 March 2027 | yes, on a special declaration | disputed |
| Karta CUKR | 3 years, renewable | yes, no permit | full |
| Karta czasowego pobytu (work) | up to 3 years | yes, tied to employer | full |
| EU Blue Card | up to 5 years | yes, simplified mobility | full |
| Karta stałego pobytu (marriage, descent) | 10 years | unrestricted | n/a |
...
[Book a Ukrainian-track consultation →](/en/uslugi/karta-pobytu)

---

This article is informational. The right strategy depends on salary, business, family, and 5-year plans. For individual matters, please obtain legal advice.

**Related materials:**
- [Karta CUKR for Ukrainians](/en/blog/karta-cukr-dlya-ukraincev)
- [EU Blue Card vs Karta Pobytu 2026](/en/blog/eu-blue-card-vs-karta-pobytu-2026)
- Service: [karta pobytu for Ukrainians](/en/uslugi/karta-pobytu)
