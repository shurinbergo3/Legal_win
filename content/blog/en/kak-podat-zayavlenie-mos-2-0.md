...
title: 'MOS 2.0 in Poland 2026: How to Submit Online'
description: >-
  Filing karta pobytu through MOS v2.0: account, Profil Zaufany, wniosek,
  Załącznik nr 1, biometrics, common errors. Real timeline in Mazowieckie.
locale: en
...
keywords:
  - MOS 2.0 how to file
  - mos.cudzoziemcy.gov.pl guide
  - karta pobytu online
  - Profil Zaufany application
...
If you do not have a Profil Zaufany, activate it through online banking (PKO BP, Santander, mBank, Pekao, ING, Millennium) - takes 5 minutes. Without a PESEL, first visit the Urząd Dzielnicy and complete meldunek + PESEL (separate guide on [PESEL and Profil Zaufany](/en/blog/pesel-profil-zaufany-mdowod-posle-karty-pobytu)).
...
| Stage | Time |
|---|---|
| Account registration in MOS | 30 minutes |
| Filling in the wniosek and załączniki | 4-8 hours of work |
| Załącznik nr 1 from employer | 1-14 days |
| Signing and submitting | 5 minutes |
| Acceptance for review | 5-14 days |
| Biometrics | 30-60 days after UPO |
| Decision in Mazowieckie | 8-14 months |
| Card production | 7-14 days |
| **Total to card collection** | **9-16 months** |
