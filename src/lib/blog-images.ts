...
const SLUG_TO_IMAGE: Record<string, string> = {
  ...
  'brak-s-polyakom-registratsiya': '/services/karta-stalego-pobytu.webp',
  'cheklist-novopribyvshih-v-polshu': '/services/meldunek.webp',
  'jdg-dlya-inostrancev-v-polshe': '/services/pomoc-w-zatrudnieniu.webp',
  ...
  'karta-polaka-kak-poluchit': '/services/obywatelstwo.webp',
  'karta-stalego-pobytu-pmzh-polsha-2026': '/services/karta-stalego-pobytu.webp',
  'kod-95-polsha-kak-poluchit': '/services/kod-95.webp',
  'legalizacja-w-polshe-warszawa': '/services/karta-pobytu.webp',
  ...
  'otkrytie-bankovskogo-scheta-v-polshe': '/services/zaswiadczenia-zus-us.webp',
  'otkrytie-sp-z-o-o-polsha-instrukciya': '/services/pomoc-w-zatrudnieniu.webp',
  ...
  'razreshenie-mswia-pokupka-nedvizhimosti-inostrancem': '/services/wyszukiwanie-mieszkania.webp',
  'nalogovoye-rezidentstvo-polsha-183-dnya': '/services/zaswiadczenia-zus-us.webp',
  ...
  'nalogovye-lgoty-estonian-cit-ip-box': '/services/zaswiadczenia-zus-us.webp',
  ...
  'arenda-kommercheskoy-nedvizhimosti-varshava': '/services/wyszukiwanie-mieszkania.webp',
