...
export const BLOG_FAQ_2026_Q4: Map = {
  ...
  'zameldowanie-bez-soglasiya-sobstvennika-2026': {
    ru: [
      ...
      { q: 'Сколько длится административная процедура прописки?', a: 'В Варшаве обычно от 6 недель до 3 месяцев. Срок зависит от гмины и от того, отвечает ли собственник на вызовы уряда.' },
  ...
  'zaswiadczenie-o-zameldowaniu-2026': {
    ru: [
      ...
      { q: 'Принимают ли выписку из mObywatel вместо бумажной справки?', a: 'Внутри Польши обычно да - электронный документ с печатью уряда равнозначен бумажному. Для апостиля и для части иностранных органов нужен бумажный оригинал.' },
  ...
  'wymeldowanie-i-fiktivnaya-propiska-2026': {
    ru: [
      ...
      { q: 'Как собственнику выписать жильца, который съехал?', a: 'Подать wniosek o wymeldowanie w trybie administracyjnym. Urząd устанавливает факт непроживания по доказательствам и выносит decyzję; пошлина - 10 PLN, срок обычно 4-12 недель.' },
