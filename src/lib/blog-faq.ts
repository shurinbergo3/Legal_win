...
import { BLOG_FAQ_2026_Q3 } from './blog-faq-2026-q3';
...
export const BLOG_FAQ: Map = {
  ...
  'karta-pobytu-2026-poshagovaya-instrukciya': {
    ...
    uk: [
      ...
      { q: 'Що таке MOS v2.0 і чи обов’язково подавати через нього?', a: 'MOS v2.0 - це нова державна електронна система для іноземців, що замінила inPOL з 27 квітня 2026. З 2026 року це єдиний канал подачі wniosku (заяви) про kartę czasowego pobytu (карту тимчасового перебування). Паперову подачу воєводи більше не приймають.' },
    ...
    pl: [
      ...
      { q: 'Czym jest MOS v2.0 i czy trzeba składać tylko przez ten system?', a: 'MOS v2.0 to nowa rządowa platforma dla cudzoziemców, która od 27 kwietnia 2026 zastąpiła inPOL. Od 2026 to jedyny kanał składania wniosków o kartę czasowego pobytu - papierowe wnioski u wojewody nie są już przyjmowane.' },
    ...
    en: [
      ...
      { q: 'What is MOS v2.0 and is it the only filing channel?', a: 'MOS v2.0 is the new state e-platform for foreigners, replacing inPOL from 27 April 2026. From 2026 it is the only channel - wojewody (regional governors) no longer accept paper applications.' },
    ...
    tr: [
      ...
      { q: 'MOS v2.0 nedir ve başvuru zorunlu olarak bu sistem üzerinden mi yapılır?', a: 'MOS v2.0 yabancılar için yeni devlet elektronik başvuru sistemidir. 27 Nisan 2026\'te inPOL\'un yerini almıştır. 2026\'dan itibaren karta czasowego pobytu wniosek başvuruları için tek kanaldır. Kâğıt başvurular eyalet valiliklerince artık kabul edilmez.' },
  ...
  'karta-stalego-pobytu-pmzh-polsha-2026': {
    ru: [
      ...
      { q: 'Можно ли работать в Польше с karta stałego pobytu без zezwolenia?', a: 'Да. Karta stałego pobytu (карта постоянного пребывания) даёт безусловное право работать на любого работодателя без zezwolenia na pracę (разрешения на работу) и без обязанности уведомлять wojewodę (воеводу) о смене работы.' }
    ],
    uk: [
  ...
  'kod-95-polsha-kak-poluchit': {
    ru: [
      ...
      { q: 'Какие три пути получения Kod 95 в Польше?', a: 'Kwalifikacja wstępna (начальная квалификация) 280 часов (для новичков 18+), kwalifikacja wstępna przyspieszona (ускоренная начальная квалификация) 140 часов (с 21 для C, с 23 для D), либо szkolenie okresowe (периодическое обучение) 35 часов раз в 5 лет (для тех, у кого Kod 95 уже был).' },
      { q: 'Сколько стоит Kod 95 в Польше в 2026?', a: 'Kwalifikacja wstępna pełna (полная начальная квалификация) - от 5 000 PLN, przyspieszona (ускоренная) - от 3 600 PLN, szkolenie okresowe (периодическое обучение) - от 700 PLN. Плюс badania lekarskie i psychologiczne (медосмотр и психологические обследования, 200 PLN за медкомиссию и 150 PLN за психотест) и государственный экзамен в WORD (Воеводском центре дорожного движения, 50 PLN).' },
    ...
    uk: [
      ...
      { q: 'Скільки коштує Kod 95 у Польщі у 2026 році?', a: 'Kwalifikacja wstępna pełna — від 5 000 PLN, przyspieszona — від 3 600 PLN, szkolenie okresowe — від 700 PLN. Плюс badania lekarskie (200 + 150 PLN) та іспит у WORD (50 PLN).' },
    ...
    pl: [
      ...
      { q: 'Jakie są trzy ścieżki uzyskania Kod 95?', a: 'Kwalifikacja wstępna 280 h (od 18 lat), kwalifikacja wstępna przyspieszona 140 h (od 21 dla C, od 23 dla D), albo szkolenie okresowe 35 h co 5 lat dla osób z istniejącym wpisem.' },
      { q: 'Ile kosztuje Kod 95 w Polsce w 2026?', a: 'Kwalifikacja pełna - od 5 000 PLN, przyspieszona - od 3 600 PLN, szkolenie okresowe - od 700 PLN. Plus badania lekarskie i psychologiczne (200 + 150 PLN) i egzamin państwowy w WORD (50 PLN).' },
    ...
    en: [
      ...
      { q: 'What are the three routes to Code 95 in Poland?', a: 'Initial qualification 280 hours (from 18 yrs), accelerated initial qualification 140 hours (from 21 for C, 23 for D), or periodic training 35 hours every 5 years for drivers who already hold Code 95.' },
      { q: 'How much does Code 95 cost in Poland in 2026?', a: 'Full initial qualification: from PLN 5,000. Accelerated: from PLN 3,600. Periodic training: from PLN 700. Plus medical/psychological tests (PLN 200 + PLN 150) and the state exam at WORD (regional driving-test centre, PLN 50).' },
    ...
    tr: [
      ...
      { q: 'Polonya\'da Kod 95 alımının üç yolu nedir?', a: 'Kwalifikacja wstępna (başlangıç yeterliliği) 280 saat (18 yaş üstü yeni başlayanlar için), kwalifikacja wstępna przyspieszona (hızlandırılmış başlangıç yeterliliği) 140 saat (C için 21, D için 23 yaş üstü), veya 5 yılda bir szkolenie okresowe (periyodik eğitim) 35 saat (Kod 95\'i halihazırda olanlar için).' },
      { q: '2026\'da Polonya\'da Kod 95 ne kadar tutar?', a: 'Kwalifikacja wstępna pełna (tam başlangıç yeterliliği) 5.000 PLN\'den, przyspieszona (hızlandırılmış) 3.600 PLN\'den, szkolenie okresowe (periyodik eğitim) 700 PLN\'den başlar. Ek olarak badania lekarskie i psychologiczne (tıbbi ve psikolojik muayeneler, 200 PLN ve 150 PLN) ve WORD\'de (Eyalet Trafik Merkezi) devlet sınavı (50 PLN).' },
  ...
  'kod-95-kwalifikacja-wstepna-vs-szkolenie-okresowe': {
    ru: [
      ...
      { q: 'Можно ли заменить kwalifikację wstępną на szkolenie okresowe?', a: 'Нет. Это разные процедуры. Если Kod 95 истёк больше года назад, нужно заново пройти kwalifikację wstępną (начальную квалификацию) - szkolenie okresowe (периодическое обучение) не годится.' }
    ],
    uk: [
  ...
  'obmen-tureckih-prav-na-polskie': {
    ...
    tr: [
      ...
      { q: 'Türk ehliyeti değişimi ne kadar tutar?', a: 'Yeni tip A/B için toplam 180-230 PLN: opłata komunikacyjna 100,50 PLN, yeminli tercüme 80-130 PLN. Eski tip için apostille 60-80 PLN ek olarak gelir. C ve D sınıflarında sağlık raporu (180-250 PLN) ve psikoteknik (150 PLN) ile toplam 490-740 PLN\'ye çıkar.' }
    ]
  },
  ...
  'pravilo-185-dney-itd-shtrafy': {
    ru: [
      ...
      { q: 'Как ITD (Дорожная транспортная инспекция) проверяет 185 дней пребывания?', a: 'По штампам в паспорте, базе MOS v2.0, meldunku (регистрации по адресу), базе ZUS и записям таможни. При проверке инспектор вправе требовать подтверждения адреса и работы. Игнорирование чревато mandatem (штрафом).' }
    ],
    uk: [
  ...
  'apostille-nostryfikacja-tlumaczenia-przysiegle': {
    ru: [
      { q: 'В чём разница apostille, nostryfikacji (нострификации) и присяжного перевода?', a: 'Apostille - международная легализация подлинности печати/подписи. Nostryfikacja - признание иностранного диплома польским вузом. Присяжный перевод - заверенный TEPIS-ом перевод текста. Все три часто требуются вместе для дипломов и документов.' },
      ...
      { q: 'Сколько стоит nostryfikacja (нострификация) диплома в Польше?', a: 'Госпошлина wuź - 50% от minimalnego wynagrodzenia (минимальной зарплаты, около 2 400 PLN в 2026). Услуги бывшего вуза по сбору - варьируются. Срок - 90-180 дней. Часто нужны дополнительные документы из страны выдачи.' }
    ],
    uk: [
      { q: 'У чому різниця між apostille, nostryfikacją і присяжним перекладом?', a: 'Apostille — міжнародна легалізація справжності печатки/підпису. Nostryfikacja — визнання іноземного диплома польським вишем. Присяжний переклад — завірений TEPIS-ом переклад тексту. Усі три часто потрібні разом для дипломів.' },
  ...
  'otkrytie-bankovskogo-scheta-v-polshe': {
    ru: [
      ...
      { q: 'Какие документы нужны для открытия счёта?', a: 'Паспорт, karta pobytu / виза D / PESEL, подтверждение адреса (договор аренды или meldunek - регистрация по адресу), подтверждение дохода (umowa o pracę - трудовой договор, оборот фирмы). Иногда - telefon польский для SMS-кода.' },
      { q: 'Можно ли открыть счёт в Польше дистанционно?', a: 'Мало банков принимают полностью удалённое открытие - большинство требует визита в отделение. Revolut, ZEN и WIO позволяют открывать через app, но с верификацией паспорта и видеосвязью.' }
    ],
    uk: [
  ...
  'nevyplata-zarplaty-zaschita-prav-inostranca-pip': {
    ru: [
      ...
      { q: 'Можно ли получить zarplatę без польского языка?', a: 'Да. Услуги PIP (Государственной инспекции труда) бесплатны и доступны переводчики (ukraiński, rosyjski, angielski). Юридическая помощь по трудному делу - от 1 500 PLN. На стадии sąd pracy (суда по трудовым делам) - обязателен польский или адвокат.' }
    ],
    uk: [
  ...
  'ksef-luty-2026-e-faktury': {
    ru: [
      { q: 'С какой даты обязателен KSeF (Национальная система электронных счетов-фактур) в Польше?', a: 'Даты разные для приёма и выставления. Принимать e-фактуры через KSeF обязаны все с 1 февраля 2026 года. Выставлять - по волнам: с 1 февраля 2026 фирмы с оборотом свыше 200 млн zł, с 1 апреля 2026 все остальные, а микрофирмы с продажами до 10 000 zł брутто в месяц могут по-старому до 31 декабря 2026. Санкции начнутся только с 1 января 2027. Это касается Sp. z o.o. (ООО), JDG-плательщиков VAT (ИП), spółek komandytowych (коммандитных товариществ), jawnych (полных товариществ) и иностранных фирм с польским stałym miejscem prowadzenia działalności (постоянным местом ведения деятельности). Бумажные фактуры и PDF по почте больше не считаются legalnymi dokumentami (юридически действительными документами).' },
    ...
    pl: [
      { q: 'Od kiedy obowiązkowy jest KSeF w Polsce?', a: 'Daty są różne dla odbioru i wystawiania. Odbierać e-faktury przez KSeF muszą wszyscy od 1 lutego 2026. Wystawiać - falami: od 1 lutego 2026 firmy z obrotem powyżej 200 mln zł, od 1 kwietnia 2026 wszyscy pozostali, a mikrofirmy ze sprzedażą do 10 000 zł brutto miesięcznie mogą po staremu do 31 grudnia 2026. Sankcje ruszają dopiero 1 stycznia 2027.' },
  ...
  'karta-pobytu-prodlenie-2026-kogda-podavat': {
    ru: [
      ...
      { q: 'Сколько стоит продление karty pobytu в 2026?', a: 'Госпошлины - 340 PLN за wniosek + 100 PLN за пластик новой karty. Сопровождение LegalWin - от 2 200 PLN. С tłumaczeniami przysięgłymi (присяжными переводами) и медстраховкой минимальная общая сумма - около 2 940 PLN.' }
    ],
    uk: [
  ...
  'zapis-na-karte-pobytu-varshava-2026': {
    ru: [
      { q: 'Как записаться на подачу документов на карту побыту в Варшаве в 2026?', a: 'Отдельная запись на подачу больше не нужна. С 27 апреля 2026 inPOL свёрнут, и wniosek подаётся онлайн через MOS v2.0 (mos.cudzoziemcy.gov.pl). Вы входите через Profil Zaufany, login.gov.pl, e-dowód или mDowód, заполняете заявление, загружаете документы и подписываете его электронно. После подписи получаете UPO с номером дела.' },
      { q: 'Нужно ли ловить очередь (kolejka), как было в inPOL?', a: 'Нет. Старая игра «поймать слот kolejki» осталась в прошлом вместе с inPOL. В MOS v2.0 подача полностью электронная и доступна в любой день, хоть ночью, без визита в urząd. Единственный очный визит, который остался, - это termin на биометрию, и его назначает сам Mazowiecki Urząd, а не заявитель.' },
      ...
      { q: 'Можно ли перенести назначенный termin?', a: 'Да, один раз termin на биометрию переносится бесплатно - через личный кабинет или обращение в urząd. Дальнейшие переносы уже на усмотрение urzędu. Учтите: пока биометрия не сдана, decyzja не выносится, поэтому систематические переносы только затягивают дело. Первый бесплатный перенос лучше держать на действительно непредвиденную ситуацию.' }
    ],
    pl: [
      { q: 'Jak zapisać się na złożenie dokumentów na kartę pobytu w Warszawie w 2026?', a: 'Osobny zapis na złożenie nie jest już potrzebny. Od 27 kwietnia 2026 inPOL wyłączono, a wniosek składa się online przez MOS v2.0 (mos.cudzoziemcy.gov.pl). Logujesz się przez Profil Zaufany, login.gov.pl, e-dowód lub mDowód, wypełniasz wniosek, wgrywasz dokumenty i podpisujesz go elektronicznie. Po podpisie otrzymujesz UPO z numerem sprawy.' },
    ...
    tr: [
      { q: '2026 yılında Varşova\'da karta pobytu belgeleri için randevu nasıl alınır?', a: 'Teslim için ayrı bir randevu artık gerekmez. 27 Nisan 2026\'ten itibaren inPOL kapatıldı; wniosek MOS v2.0 (mos.cudzoziemcy.gov.pl) üzerinden çevrimiçi yapılır. Profil Zaufany, login.gov.pl, e-dowód veya mDowód ile giriş yapar, başvuruyu doldurur, belgeleri yükler ve elektronik imzalarsınız. İmzadan sonra dosya numaralı UPO alırsınız.' },
  ...
  'obmen-ukrainskih-prav-na-polskie-2026': {
    ...
    uk: [
      ...
      { q: 'Де у Варшаві поміняти українські права?', a: 'У Wydziale Komunikacji того Urzędu Dzielnicy, до якого належить ваш meldunek: Śródmieście (Nowogrodzka 43), Mokotów (Rakowiecka 25/27), Ursynów (KEN 61), Wola (al. Solidarności 90), Praga-Południe (Grochowska 274), Bemowo (Powstańców Śląskich 70). Запис через warszawa19115.pl; у гарячий сезон - за 3 тижні.' },
  ...
  'obmen-belorusskih-prav-na-polskie-2026': {
    ...
    uk: [
      ...
      { q: 'Де поміняти білоруські права у Варшаві?', a: 'У Wydziale Komunikacji того Urzędu Dzielnicy, до якого належить ваш meldunek: Śródmieście - ul. Nowogrodzka 43, Mokotów - ul. Rakowiecka 25/27, Ursynów - al. KEN 61, Wola - al. Solidarności 90, Praga-Południe - ul. Grochowska 274, Bemowo - ul. Powstańców Śląskich 70. Запис через warszawa19115.pl, у гарячий сезон - за 3 тижні.' },
  ...
  'obmen-rossijskih-prav-na-polskie-2026': {
    ...
    uk: [
      ...
      { q: 'Скільки коштує обмін російських прав у Польщі?', a: 'Для категорії B - близько 180-270 PLN: opłata komunikacyjna 100,00 + opłata ewidencyjna 0,50 + tłumaczenie przysięgłe 70-110 PLN. Apostille, якщо знадобиться, додасть ~60 PLN. Для категорій C/D з медициною виходить 490-740 PLN. Супровід юриста - плюс 400-600 PLN.' },
      { q: 'Де у Варшаві поміняти російські права?', a: 'У Wydziale Komunikacji того Urzędu Dzielnicy, до якого належить ваш meldunek: Śródmieście (Nowogrodzka 43), Mokotów (Rakowiecka 25/27), Ursynów (KEN 61), Wola (Solidarności 90), Praga-Południe (Grochowska 274), Bemowo (Powstańców Śląskich 70). Запис - через warszawa19115.pl, у гарячий сезон за 3 тижні.' },
  ...
  'apostille-spravki-o-nesudimosti': {
    ru: [
      { q: "Кто ставит apostille на справку о несудимости в Польше?", a: "Apostille на польскую справку KRK ставит Ministerstwo Spraw Zagranicznych (MSZ). Госпошлина - 60 PLN за документ. При личной подаче апостиль ставят в день визита, по почте - до 30 дней. Экспресс-тарифа у MSZ нет. Свидетельства USC апостилирует тот же MSZ, а вот дипломы вузов - нет, там NAWA." },
      ...
      { q: "Сколько стоит apostille на справку о несудимости?", a: "Госпошлина MSZ - 60 PLN, присяжный перевод - около 80 PLN за документ. Пакет 'KRK + apostille + перевод' под ключ у нас - от 720 PLN. Для ОАЭ добавляется консульская легализация - отдельно." },
    ...
    pl: [
      { q: "Kto przybija apostille na zaświadczeniu o niekaralności w Polsce?", a: "Apostille na polskim KRK przybija Ministerstwo Spraw Zagranicznych (MSZ). Opłata - 60 zł za dokument. Przy złożeniu osobistym apostille nadawana jest w dniu wizyty, korespondencyjnie - do 30 dni. MSZ nie ma trybu ekspresowego. Odpisy USC apostilluje ten sam MSZ, a dyplomy uczelni już nie - tam NAWA." },
      ...
      { q: "Ile kosztuje apostille na zaświadczeniu o niekaralności?", a: "Opłata MSZ - 60 zł, tłumaczenie przysięgłe - około 80 zł za dokument. Pakiet 'KRK + apostille + tłumaczenie' pod klucz u nas - od 720 PLN. Do ZEA dochodzi legalizacja konsularna - osobno." },
    ...
    en: [
      { q: "Who affixes the apostille on a certificate of no criminal record in Poland?", a: "The apostille on the Polish KRK is affixed by the Ministerstwo Spraw Zagranicznych (MSZ). The fee is 60 PLN per document. Filed in person the apostille is issued during the visit; by post it takes up to 30 days. MSZ has no express tariff. USC certificates are apostilled by the same MSZ, while university diplomas go to NAWA." },
      ...
      { q: "How much does an apostille on a certificate of no criminal record cost?", a: "The MSZ fee is 60 PLN and a sworn translation about 80 PLN per document. Our end-to-end 'KRK + apostille + translation' package is from 720 PLN. For the UAE, consular legalisation is added separately." },
    ...
    tr: [
      { q: "Polonya'da adli sicil belgesine apostille'yi kim vurur?", a: "Polonya KRK'sine apostille'yi Ministerstwo Spraw Zagranicznych (MSZ) vurur. Ücret belge başına 60 PLN. Şahsen başvuruda apostille ziyaret günü verilir, postayla 30 güne kadar sürer. MSZ'de ekspres tarife yoktur. USC belgelerini de aynı MSZ apostille'ler; üniversite diplomaları NAWA'ya gider." },
      ...
      { q: "Adli sicil belgesine apostille ne kadar?", a: "MSZ ücreti 60 PLN, yeminli tercüme belge başına yaklaşık 80 PLN. Anahtar teslim 'KRK + apostille + tercüme' paketimiz 720 PLN'den. BAE için konsolosluk tasdiki ayrıca eklenir." },
    ...
    uk: [
      { q: "Хто ставить apostille на довідку про несудимість у Польщі?", a: "Apostille на польський KRK ставить Ministerstwo Spraw Zagranicznych (MSZ). Держмито - 60 PLN за документ. За особистого подання апостиль ставлять у день візиту, поштою - до 30 днів. Експрес-тарифу в MSZ немає. Свідоцтва USC апостилює той самий MSZ, а дипломи ЗВО - ні, там NAWA." },
      ...
      { q: "Скільки коштує apostille на довідку про несудимість?", a: "Держмито MSZ - 60 PLN, присяжний переклад - близько 80 PLN за документ. Пакет 'KRK + apostille + переклад' під ключ у нас - від 720 PLN. Для ОАЕ додається консульська легалізація - окремо." },
  ...
  'apostille-svidetelstv-usc-wojewoda': {
    ru: [
      { q: "Кто ставит apostille на свидетельство о рождении или браке?", a: "На свидетельства USC (akt urodzenia, małżeństwa, zgonu), как и на остальные польские документы, apostille ставит MSZ на ul. Krucza 38/42 в Варшаве. Совет идти к воеводе - распространённое заблуждение, воевода апостилем не занимается. Госпошлина - 60 PLN за документ." },
      ...
      { q: "В каком порядке делать apostille свидетельства для заграницы?", a: "Сначала свежий odpis из USC, потом apostille в MSZ, и только затем присяжный перевод вместе с текстом штампа. Перевод до apostille означает, что переводить придётся заново." },
      { q: "Нужно ли ехать в Варшаву за apostille?", a: "Апостиль ставит только MSZ в Варшаве, но приезжать лично не обязательно: документы можно отправить почтой на al. Szucha 23 (до 30 дней) или оформить подачу по доверенности. Неважно, в каком воеводстве выдано свидетельство - орган один." }
    ],
    pl: [
      { q: "Kto przybija apostille na akcie urodzenia lub małżeństwa?", a: "Na odpisach USC (akt urodzenia, małżeństwa, zgonu), tak jak na pozostałych polskich dokumentach, apostille nadaje MSZ przy ul. Kruczej 38/42 w Warszawie. Rada, żeby iść do wojewody, to rozpowszechniony mit - wojewoda apostille nie nadaje. Opłata - 60 zł za dokument." },
      ...
      { q: "W jakiej kolejności robić apostille odpisu za granicę?", a: "Najpierw świeży odpis z USC, potem apostille w MSZ, a dopiero później tłumaczenie przysięgłe razem z tekstem klauzuli. Tłumaczenie przed apostille oznacza, że trzeba będzie tłumaczyć ponownie." },
      { q: "Czy trzeba jechać do Warszawy po apostille?", a: "Apostille nadaje wyłącznie MSZ w Warszawie, ale osobisty przyjazd nie jest konieczny: dokumenty można wysłać pocztą na al. Szucha 23 (do 30 dni) albo złożyć przez pełnomocnika. Nie ma znaczenia, w którym województwie wydano odpis - organ jest jeden." }
    ],
    en: [
      { q: "Who affixes the apostille on a birth or marriage certificate?", a: "On USC certificates (akt urodzenia, małżeństwa, zgonu), as on every other Polish official document, the apostille is affixed by the MSZ at ul. Krucza 38/42 in Warsaw. The advice to go to the wojewoda is a widely repeated myth - the wojewoda does not issue apostilles. The fee is 60 PLN per document." },
      ...
      { q: "In what order do I apostille a certificate for abroad?", a: "First a fresh odpis from the USC, then the apostille at the MSZ, and only then a sworn translation together with the stamp text. Translating before the apostille means you will translate again." },
      { q: "Do I have to travel to Warsaw for the apostille?", a: "Only the MSZ in Warsaw issues apostilles, but you do not have to come in person: documents can go by post to al. Szucha 23 (up to 30 days) or be filed under a power of attorney. It makes no difference which voivodeship issued the certificate - there is one authority." }
    ],
    tr: [
      { q: "Doğum veya evlilik belgesine apostille'yi kim vurur?", a: "USC belgelerine (akt urodzenia, małżeństwa, zgonu) de, diğer tüm Polonya resmi belgelerinde olduğu gibi, apostille'yi Varşova ul. Krucza 38/42 adresindeki MSZ vurur. Valiye gidin tavsiyesi yaygın bir yanlış bilgidir - vali apostille vurmaz. Ücret belge başına 60 PLN." },
      ...
      { q: "Yurt dışı için belge apostille'sini hangi sırayla yapmalı?", a: "Önce USC'den taze odpis, sonra MSZ'de apostille, ancak ondan sonra şerh metniyle birlikte yeminli tercüme. Apostille'den önce tercüme, yeniden tercüme gerektirir." },
      { q: "Apostille için Varşova'ya gitmek şart mı?", a: "Apostille'yi yalnızca Varşova'daki MSZ vurur, ama bizzat gitmek şart değildir: belgeler al. Szucha 23 adresine postayla gönderilebilir (30 güne kadar) veya vekâletnameyle sunulabilir. Belgenin hangi eyalette verildiğinin önemi yoktur - kurum tektir." }
    ],
    uk: [
      { q: "Хто ставить apostille на свідоцтво про народження чи шлюб?", a: "На свідоцтва USC (akt urodzenia, małżeństwa, zgonu), як і на решту польських документів, apostille ставить MSZ на ul. Krucza 38/42 у Варшаві. Порада йти до воєводи - поширена помилка, воєвода апостилем не займається. Держмито - 60 PLN за документ." },
      ...
      { q: "У якому порядку робити apostille свідоцтва для закордону?", a: "Спершу свіжий odpis із USC, потім apostille в MSZ, і лише тоді присяжний переклад разом із текстом штампа. Переклад до apostille означає, що перекладати доведеться заново." },
      { q: "Чи треба їхати до Варшави за apostille?", a: "Апостиль ставить лише MSZ у Варшаві, але приїжджати особисто не обов'язково: документи можна надіслати поштою на al. Szucha 23 (до 30 днів) або подати за довіреністю. Не має значення, в якому воєводстві видано свідоцтво - орган один." }
    ]
  },
