...
2. CITIZENSHIP
- By descent (potwierdzenie obywatelstwa): proof of Polish ancestor who retained citizenship.
- Naturalization (nadanie): 3 years of stały pobyt + language B1 + stable income; Prezydent RP decides.
- Recognition (uznanie): shorter paths via marriage, refugee status, or long-term residence; voivode decides.
...
4. TAX
- VAT: standard 23%, reduced 8% / 5% / 0%. Registration required above 200,000 PLN turnover or on voluntary basis for EU VAT-OSS.
- PIT: residents taxed on worldwide income; scale 12% / 32% or flat 19% (B2B) or ryczałt.
- Exit tax, transfer pricing, CRS / FATCA reporting for HNW clients.
