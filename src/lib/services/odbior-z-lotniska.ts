...
const odbiorZLotniska: ServiceEntry = {
  ru: {
    ...
    grounds: {
      ...
      items: [
        { title: 'Встреча с табличкой', desc: 'Юрист с табличкой LegalWin в зоне прилёта. Поможет с паспортным контролем (EES), переводом вопросов pograniczników, поиском багажа.' },
    ...
    timeline: {
      ...
      subtitle: 'От первого письма с рейсом до spokойного вечера в новой квартире.',
      steps: [
        ...
        { title: 'Прилёт и встреча', duration: '15 мин', desc: 'Юрист с табличкой ждёт у выхода паспортного контроля. Кофе при необходимости, помощь с тележкой.' },
    ...
    documents: {
      ...
      items: [
        ...
        'Контактный мобильный (WhatsApp / Telegram)',
    ...
    pricing: {
      ...
      items: [
        ...
        { label: 'Трансфер + заселение', value: 'от 450 PLN', note: 'С юристом-сопровождением до жилья' },
    ...
    faq: [
      ...
      { q: 'Можно ли забрать ребёнка одного (UMNR)?', a: 'Да. У нас есть юристы, аккредитованные авиалиниями (LOT, Ryanair, Wizz Air) для встречи UMNR (несопровождаемых детей). Нужны заранее оформленные доверенности от родителей и копии паспортов.' },
    ...
    ctaSubtitle: 'Бесплатное планирование: высылайте рейс — подтвердим время и стоимость в течение часа. Юрист с табличкой ждёт вас у выхода.'
  },
  pl: {
    slug: 'odbior-z-lotniska',
    group: 'relocation',
    ...
    lead: 'Przylot do nieznanego kraju to stres. Bez polskiego, z dziećmi, walizkami, bez znajomości realiów. LegalWin spotyka w strefie przylotów z tabliczką, pomaga przejść kontrolę EES, organizuje transfer i pierwszy dzień: zameldowanie, SIM, zakupy, instruktaż. To nie tylko taxi — to prawne towarzyszenie pierwszego dnia w Polsce.',
    facts: [
    ...
    grounds: {
      ...
      items: [
        { title: 'Spotkanie z tabliczką', desc: 'Prawnik z tabliczką LegalWin. Pomoc z kontrolą EES, tłumaczenie pograniczników, bagaż.' },
    ...
    timeline: {
      ...
      steps: [
        ...
        { title: 'Spotkanie', duration: '15 min', desc: 'Prawnik z tabliczką po kontroli paszportowej. Kawa, wózek z bagażem.' },
    ...
    documents: {
      ...
      items: [
        ...
        'Telefon kontaktowy (WhatsApp/Telegram)',
    ...
    pricing: {
      ...
      items: [
        ...
        { label: 'Transfer + zameldowanie', value: 'od 450 PLN', note: 'Z prawnikiem do mieszkania' },
    ...
    ctaSubtitle: 'Bezpłatne planowanie: prześlij lot — w godzinę odpowiedź. Prawnik z tabliczką czeka po kontroli.'
  },
  en: {
    slug: 'odbior-z-lotniska',
    group: 'relocation',
    ...
    grounds: {
      ...
      items: [
        { title: 'Sign meeting at arrivals', desc: 'LegalWin lawyer with sign. Help with EES check, border-officer translation, baggage.' },
    ...
    timeline: {
      ...
      steps: [
        ...
        { title: 'Meet & greet', duration: '15 min', desc: 'Lawyer with sign past customs. Coffee, baggage trolley.' },
    ...
    documents: {
      ...
      items: [
        ...
        'Mobile contact (WhatsApp/Telegram)',
    ...
    pricing: {
      ...
      items: [
        ...
        { label: 'Transfer + check-in', value: 'from 450 PLN', note: 'Lawyer accompaniment to housing' },
    ...
    faq: [
      ...
      { q: 'Unaccompanied minor (UMNR)?', a: 'Yes — lawyers accredited by LOT, Ryanair, Wizz Air. Pre-issued parental authorisations required.' },
    ...
    ctaSubtitle: 'Free planning: send your flight — confirmation within an hour. A lawyer with a sign waits past customs.'
  }
};
