...
const meldunek: ServiceEntry = {
  ru: {
    ...
    timeline: {
      ...
      steps: [
        { title: 'Консультация', duration: '20 мин', desc: 'Уточняем форму пребывания, тип meldunku (czasowy/stały), наличие согласия собственника жилья.' },
    ...
    faq: [
      ...
      { q: 'Что если арендодатель отказывается прописывать?', a: 'Мы помогаем составить договор аренды с пунктом о согласии на zameldowanie (регистрацию) или подбираем владельцев, готовых к meldunku. Альтернатива - meldunek у работодателя, родственника или через адрес LegalWin для предпринимателей.' },
  ...
  uk: {
    ...
    timeline: {
      ...
      steps: [
        { title: 'Консультація', duration: '20 хв', desc: 'Уточнюємо форму перебування, тип meldunku (czasowy/stały), наявність згоди власника житла.' },
    ...
    faq: [
      ...
      { q: 'Що робити, якщо орендодавець відмовляється прописувати?', a: 'Ми допомагаємо скласти договір оренди з пунктом про згоду на zameldowanie (реєстрацію) або підбираємо власників, готових до meldunku. Альтернатива — meldunek у роботодавця, родича чи через адресу LegalWin для підприємців.' },
