...
const wymianaPrawaJazdy: ServiceEntry = {
  ru: {
    ...
    documents: {
      ...
      items: [
        ...
        'Подтверждение opłaty 100,50 PLN'
      ]
    },
    pricing: {
    ...
    faq: [
      ...
      { q: 'Какие штрафы за управление без замены прав?', a: 'Управление авто с правами, подлежащими обмену, после 185 дней - нарушение art. 94 ustawy Prawo o ruchu drogowym (статья 94 Закона о дорожном движении). Штраф 500 PLN + 6 пунктов карных. Полиция проверяет дату въезда по PESEL/meldunku (регистрации) - обмануть нельзя.' }
    ],
  ...
  uk: {
    ...
    subtitle: 'Обмін українських та інших не-ЄС прав на польські',
    lead: 'За польським правом іноземець, що проживає в Польщі понад 185 днів, зобов’язаний обміняти іноземні водійські права на польські. Без обміну через 6 місяців права втрачають легальність для керування авто. Обмінюємо права з України, Білорусі, Казахстану, Грузії, Молдови та інших країн — оформлюємо присяжні переклади, badania lekarskie, психотест, заяву в starostwo та супровід у WORD при необхідності перескладання теорії.',
    facts: [
      { label: 'Термін видачі', value: '14–30 днів', note: 'starostwo · за воєводством' },
      { label: 'Держмито', value: '100,50 PLN', note: 'opłata za blankiet prawa jazdy' },
      { label: 'Де', value: 'Starostwo + WORD', note: 'управління + теоретичний іспит' },
      { label: 'Діє', value: 'до 15 років', note: 'B / B+E · менше для C, D' }
    ],
    grounds: {
      title: 'Які права обмінюємо',
      subtitle: 'Польща працює за двосторонніми договорами та Віденською конвенцією 1968 р. Не всі категорії та країни обмінюються автоматично.',
      items: [
        { title: 'Україна (B, BE)', desc: 'Без складання теорії та практики — прямий обмін. Категорії C, CE, D, DE — потрібне складання теорії WORD. Термін — 30 днів.' },
        { title: 'Білорусь (B, BE)', desc: 'Прямий обмін за двосторонньою угодою 2003 року. Категорії вантажівок та автобусів — складання теорії.' },
        { title: 'Казахстан, Киргизстан, Узбекистан', desc: 'Обмін за Віденською конвенцією. Часто — складання теорії. Уточнюємо за конкретним воєводством.' },
        { title: 'Молдова, Грузія, Вірменія, Азербайджан', desc: 'Віденська конвенція або двосторонні договори. C/D завжди — теорія. B — зазвичай прямий обмін.' },
        { title: 'Велика Британія (post-Brexit)', desc: 'Прямий обмін протягом 5 років проживання в Польщі. Після — теорія і практика заново.' },
        { title: 'США, Канада', desc: 'Лише B — прямий обмін за двостороннім договором. C/D — повний курс заново.' },
        { title: 'Турція (B, BE)', desc: 'Прямий обмін за Віденською конвенцією. C/D зазвичай вимагають теорію WORD.' },
        { title: 'Сирія, Ірак, Афганістан, Ємен', desc: 'Повний курс заново — без обміну. Допомагаємо з курсом OSK українською/арабською та складанням у WORD.' }
      ]
    },
    timeline: {
      title: 'Як ми оформлюємо обмін',
      subtitle: 'Стандартний цикл — 30–45 днів. З теорією WORD — до 60 днів.',
      steps: [
        { title: 'Консультація', duration: '20 хв', desc: 'Перевіряємо країну та категорію прав, статус (карта побуту, віза D, безвіз), потребу в теорії. Складаємо точний план.' },
        { title: 'Присяжний переклад прав', duration: '2–3 дні', desc: 'Tłumacz przysięgły перекладає обидві сторони іноземних прав — обов’язкова вимога starostwa.' },
        { title: 'Badania lekarskie', duration: '1–2 дні', desc: 'Записуємо в акредитований медцентр (uprawniony lekarz) — 200 PLN, 30 хвилин. Категорія 1 (B) або 2 (C/D).' },
        { title: 'Психологічний тест', duration: '1 день', desc: 'Лише для C/D або при особливих вимогах. Psychotechnika — 200 PLN, 1 година.' },
        { title: 'Wniosek в starostwo', duration: '1 день', desc: 'Подання документів у wydział komunikacji starostwa за адресою проживання. Оплата 100,50 PLN.' },
        { title: 'Теорія в WORD (за потреби)', duration: '1–14 днів', desc: 'Запис на egzamin teoretyczny польською, українською або англійською. 30 питань, прохідний бал 68/74.' },
        { title: 'Отримання польських прав', duration: '14–30 днів', desc: 'Староста видає polskie prawo jazdy і забирає оригінал іноземних. Іноземні відправляються в країну видачі.' }
      ]
    },
    documents: {
      title: 'Що потрібно від вас',
      subtitle: 'Базовий пакет. Точний перелік — після консультації.',
      items: [
        'Іноземні водійські права (оригінал + копії обох сторін)',
        'Присяжний переклад прав польською',
        'Закордонний паспорт (оригінал + копія сторінки з фото)',
        'PESEL і meldunek (або підтвердження перебування понад 185 днів)',
        'Karta pobytu або інший документ легального перебування',
        'Orzeczenie lekarskie категорії 1 (B) або 2 (C/D)',
        'Orzeczenie psychologiczne (лише для C/D або за показаннями)',
        'Кольорове фото 35×45 мм (біометричний формат, білий фон)',
        'Заповнений wniosek o wydanie prawa jazdy — готуємо ми',
        'Підтвердження сплати 100,50 PLN'
      ]
    },
    pricing: {
      title: 'Вартість роботи',
      subtitle: 'Фіксований гонорар за етап. Держмита та медкомісія — окремо за фактом.',
      items: [
        { label: 'Консультація', value: 'Безкоштовно', note: '20 хвилин · оцінка ситуації' },
        { label: 'Обмін прав під ключ', value: 'від 600 PLN', note: 'Переклад, медкомісія, starostwo' },
        { label: 'Обмін + теорія WORD', value: 'від 950 PLN', note: 'З підготовкою та супроводом' },
        { label: 'Повний курс OSK з нуля', value: 'від 1 800 PLN', note: 'Категорія B · якщо обмін неможливий' }
      ],
      note: 'Зазначено гонорари LegalWin. Держмито (100,50 PLN), badania lekarskie (~200 PLN), psychotechnika (~200 PLN), присяжний переклад (~80 PLN), egzamin WORD (50 PLN/категорія) — окремо. Курс OSK (1 800–4 500 PLN) — за тарифами постачальника.'
    },
    legalBase: {
      ...
      items: [
        ...
        'Rozporządzenie Ministra Infrastruktury z 24 listopada 2022 r. ws. wymiany praw jazdy wydanych za granicą',
        'Konwencja wiedeńska o ruchu drogowym z 8 listopada 1968 r.',
        'Dwustronna umowa polsko-ukraińska o wzajemnym uznawaniu praw jazdy z 2003 r.',
        'Dwustronne umowy z Białorusią (2004), Mołdawią (2014)'
      ]
    },
    faq: [
      { q: 'Скільки фактично часу займає обмін прав?', a: 'Стандарт — 30–45 днів від першого візиту до польських прав. З теорією WORD (Wojewódzki Ośrodek Ruchu Drogowego — Воєводський центр дорожного руху) — до 60 днів. Термінові випадки (якщо права закінчуються) — можемо подати без перекладу в день консультації, переклад доробимо паралельно.' },
      { q: 'Чи можна водити в Польщі з українськими/білоруськими правами?', a: 'Так, протягом 185 днів проживання. Після — обов’язково обміняти. З 2024 року ITD (Inspekcja Transportu Drogowego — Інспекція дорожного транспорту) активно перевіряє фактичний термін перебування (PESEL, meldunek — реєстрація, віза). Штраф за керування з простроченим правом обміну — 500 PLN + ризик анулювання.' },
      { q: 'Категорії C/D — чи потрібна теорія?', a: 'Майже завжди — так. Більшість воєводств вимагають egzamin teoretyczny (теоретичний іспит) WORD для комерційних категорій з країн поза ЄС. Готуємо до іспиту з польських ПДР, обираємо WORD з іспитом українською або англійською (залежить від воєводства).' },
      { q: 'Що якщо права закінчилися або втрачені?', a: 'Прострочені іноземні права не обмінюються. Потрібно спочатку відновити їх у країні видачі (через консульство або заочно), потім — обмін у Польщі. Робимо під ключ в обох випадках.' },
      { q: 'Куди відправляються оригінали іноземних прав?', a: 'Starostwo (старостат — районна адміністрація) відправляє оригінал у країну видачі (через MSZ або посольство). Це стандартна процедура для запобігання «подвійному володінню». Отримати їх назад не можна.' },
      { q: 'Чи можна отримати права на категорію C/D, якщо її не було в країні?', a: 'Ні — обмін можливий лише в еквівалентних категоріях. Якщо хочете C/D з нуля — потрібен повний курс OSK (ośrodek szkolenia kierowców — автошкола) + Kod 95 (kwalifikacja zawodowa — професійна кваліфікація водія). Див. послугу Kod 95.' },
      { q: 'Які штрафи за керування без обміну прав?', a: 'Керування авто з правами, що підлягають обміну, після 185 днів — порушення art. 94 ustawy Prawo o ruchu drogowym (стаття 94 Закону про дорожній рух). Штраф 500 PLN + 6 штрафних балів. Поліція перевіряє дату в’їзду за PESEL/meldunku (реєстрацією) — обдурити не вдасться.' }
    ],
    related: ['kod-95', 'pesel', 'tlumaczenia-przysiegle'],
    ctaTitle: 'Обмін прав за 30 днів',
    ctaSubtitle: 'Безкоштовна консультація: перевіримо країну, категорію, статус. Від першого візиту до polski prawo jazdy — зазвичай 30–45 днів. З теорією WORD — до 60 днів.'
  }
};
