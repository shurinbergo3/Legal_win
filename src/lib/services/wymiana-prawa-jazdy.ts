...
const wymianaPrawaJazdy: ServiceEntry = {
  ...
  uk: {
    ...
    faq: [
      ...
      { q: 'Які штрафи за керування без обміну прав?', a: 'Керування авто з правами, що підлягають обміну, після 185 днів — порушення art. 94 ustawy Prawo o ruchu drogowym (стаття 94 Закону про дорожній рух). Штраф 500 PLN + 6 штрафних балів. Поліція перевіряє дату в’їзду за PESEL/meldunkу (реєстрацією) — обдурити не вдасться.' }
    ],
    related: ['kod-95', 'pesel', 'tlumaczenia-przysiegle'],
