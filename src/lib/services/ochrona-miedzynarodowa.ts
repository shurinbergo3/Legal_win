...
const ochrona: ServiceEntry = {
  ru: {
    ...
    timeline: {
      ...
      steps: [
        { title: 'Заявление', duration: 'день 1', desc: 'Подаётся лично в Straży Granicznej или в воеводстве. Мы готовим вас к opowieści жизни.' },
    ...
    documents: {
      ...
      items: [
        'Документы, удостоверяющие личность (паспорт, ID, сводетельство о рождении)',
