  ...
  uk: {
    ...
    grounds: {
      ...
      items: [
        ...
        { title: 'Документи для карти побуту/карти сталого побуту', desc: 'Trudowі umowy, довідки про доходи, виписки рахунків, договори оренди — пакет іноземною мовою перекладаємо під ключ.' },
    ...
    faq: [
      ...
      { q: 'Скільки коштує переклад одного свідоцтва?', a: 'Свідоцтво про народження/шлюб (1 сторінка) — 70–80 PLN. Диплом + додаток (3–5 сторінок) — 250–400 PLN. Trudowа umowa (4–8 сторінок) — 320–650 PLN. Точна ціна — після оцінки протягом години.' },
