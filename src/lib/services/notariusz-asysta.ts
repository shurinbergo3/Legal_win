  ...
  ru: {
    ...
    grounds: {
      ...
      items: [
        ...
        { title: 'Negocjacje klauzul', desc: 'Стандартные точки споров: момент перехода собственности (z chwilą podpisania или z chwilą zapłaty?), кто оплачивает PCC и нотариуса, depozyt notarialny, право пользования до выезда продавца, сроки передачи ключей.' },
        ...
        { title: 'Pełnomocnictwo от вас', desc: 'Если вы не в Польше - оформляем pełnomocnictwo notarialne у польского консула в стране проживания (или с apostille). Мы подписываем akt от вашего имени. Вы получаете ключи и право собственности удалённо.' },
        { title: 'Передача недвижимости после aktu', desc: 'Подписание aktu ≠ передача keys. После aktu организуем protokół zdawczo-odbiorczy с фото состояния, снятием показаний счётчиков (вода, газ, prąd), передачей ключей и инструкций (alarm, отопление, окна).' },
        { title: 'Wpis do KW', desc: 'Нотариус подаёт wniosek о wpisie новой собственности в księgę wieczystą. KW обновляется за 1-4 недели. Контролируем процесс, после wpisu - подтверждение клиенту.' }
      ]
    },
    timeline: {
    ...
    faq: [
      ...
      { q: 'Как переводятся деньги при покупке?', a: 'Самый безопасный способ - depozyt notarialny (нотариальный депозит): вы переводите цену на rachunek (счёт) нотариуса перед aktem. Нотариус подтверждает płatność (платёж) продавцу, akt подписывается. После wpisu (записи) в KW (księga wieczysta - поземельную книгу) нотариус переводит деньги продавцу. Если что-то пойдёт не так - деньги возвращаются. Стоит +0,3-0,5% от цены.' },
      { q: 'Pełnomocnictwo - как работает?', a: 'Pełnomocnictwo (доверенность) - вы оформляете нотариальную доверенность на нас в Польше (если приезжаете на 1 день) или у польского консула в стране проживания (без приезда), или у местного нотариуса с apostille. С pełnomocnictwem мы подписываем akt от вашего имени, вносим деньги, получаем ключи. Вы становитесь собственником без приезда в Польшу.' },
      { q: 'Кто платит taksę notarialną?', a: 'Taksa notarialna (нотариальный сбор) - по стандарту обе стороны делят пополам, но это не закон - торгуемся. Часто продавец оплачивает свою часть (1/2), а покупатель - свою + PCC. Иногда покупатель оплачивает всё (если рынок продавца). Может быть условием umowy przedwstępnej (предварительного договора).' },
