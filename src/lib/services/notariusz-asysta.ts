...
const notariuszAsysta: ServiceEntry = {
  ru: {
    ...
    faq: [
      ...
      { q: 'Что такое PCC и кто платит?', a: 'PCC (podatek od czynności cywilnoprawnych - налог на гражданско-правовые действия) - 2% от cены nieruchomości (недвижимости) на вторичном рынку. Платит покупатель в течение 14 дней после aktu. Decyzja PCC-3 в Urzędzie Skarbowym (налоговой). На pierwszym rynku (первичном рынке от dewelopera) - VAT 8% включается в cенu, PCC не платится.' },
