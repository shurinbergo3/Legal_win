...
const pomocWZatrudnieniu: ServiceEntry = {
  ru: {
    ...
    faq: [
      { q: 'Какая средняя зарплата для иностранца в IT в Польше 2026?', a: 'Junior разработчик — 8 000–12 000 PLN brutto/мес. Mid (3–5 лет) — 13 000–20 000 PLN. Senior — 20 000–32 000 PLN. Lead / Architect — 30 000–45 000 PLN. Это для umowy o pracę. На B2B (JDG) — на 30–40% выше при той же net-выплате (за счёт IP Box и низких налогов).' },
      { q: 'Что выгоднее — umowa o pracę или B2B?', a: 'Зависит от зарплаты и опыта. До 12 000 PLN brutto — umowa o pracę (ZUS-льготы, отпуска, права). Свыше 15 000 PLN — JDG с IP Box даёт 5% налог на 70%+ дохода. Считаем под ваш конкретный кейс на консультации.' },
      { q: 'Сколько ждать zezwolenie na pracę в 2026?', a: 'Типовой срок — 14–30 дней через MOS v2.0. Высокая нагрузка на Mazowieckim — до 60 дней. Для приоритетных категорий (IT, инженерия, медики) — fast-track 7–14 дней. Срочные процедуры есть только для smart-citizenship.' },
      { q: 'Можно ли работать без zezwolenia?', a: 'Только в исключительных случаях: студенты на польской визе, граждане ЕС/ЕЭЗ/Швейцарии, обладатели TRC с правом на работу, граждане UA по «специальной» процедуре, члены семей граждан Польши. В остальных случаях работа без zezwolenia — штраф работодателю до 30 000 PLN, иностранцу — до 5 лет zakazu wjazdu.' },
      { q: 'Что такое oświadczenie o powierzeniu pracy?', a: 'Упрощённая процедура для UA, BY, RU, MD, GE, AM — работодатель регистрирует в Powiatowym Urzędzie Pracy oświadczenie за 7 дней (60 PLN), и иностранец может работать до 24 месяцев в течение последних 36. После — нужно zezwolenie na pracę или TRC. Самый быстрый путь.' },
      { q: 'Подходит ли мне Blue Card?', a: 'Да, если: 1) высшее образование (бакалавр+); 2) контракт от 12 месяцев; 3) зарплата ≥ 1,5× средней по Польше (~10 500 PLN brutto/мес. в 2026); 4) умова с польским работодателем. Преимущества: TRC на 3 года, переезд по ЕС после 18 мес., упрощённое łączenie rodzin, ускоренный путь к ПМЖ.' },
  ...
  en: {
    ...
    faq: [
      ...
      { q: 'What is oświadczenie?', a: 'Streamlined for UA, BY, RU, MD, GE, AM — employer files at the District Employment Office in 7 days (60 PLN); foreigner can work up to 24 months in any 36. Then permit or TRC. Fastest route.' },
