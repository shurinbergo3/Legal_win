...
const kartaPolaka: ServiceEntry = {
  ru: {
    ...
    faq: [
      ...
      { q: 'Можно ли подавать в Польше или только в стране проживания?', a: 'Если у вас уже есть ВНЖ или ПМЖ в Польше — подаёте у воеводы. Если живёте в стране происхождения — у консула. Через консула быстрее (нет очередей в Mazowieckim Urzędzie), но даты собеседования бронируются за 6–12 месяцев.' },
      { q: 'Какой уровень польского нужен?', a: 'Не B2 и не Полонистика — разговорный А2-B1. Консул задаёт темы из быта: rodzina, święta, polska kuchnia, historia w skrócie, geografia. Главное — отвечать на польском, а не на русском.' },
      { q: 'Сколько ждать решения?', a: '60 дней по закону, на практике 90–180 дней. Komision при konsulacie заседает раз в месяц. Если документы безупречны — выдают на месте после собеседования.' },
      { q: 'Что даёт Karta Polaka?', a: 'Бесплатная виза D (по сути виза для работы и учёбы), право работать без zezwolenia, бесплатное обучение в государственных вузах, скидки на транспорт, ускоренный путь к ПМЖ (без 4 лет ВНЖ) и гражданству (1 год после ПМЖ).' },
      { q: 'Что если предки — поляки из Волыни/Львова/Вильно/Гродно?', a: 'Это идеальная ситуация — самая распространённая основа Karty Polaka. Метрики из Kresów Wschodnich (Литва, Беларусь, Украина) работают, нужно лишь найти их в архивах. У нас сеть исследователей в Гродно, Львове, Вильнюсе.' },
      { q: 'Что делать, если фамилия русифицирована (Polski → Polski/Polskij)?', a: 'Не препятствие. Polonizacja фамилий и имён — стандартная практика для Polaków в Российской Империи и СССР. Метрики до этого периода или свидетельства о смене фамилии — разрешают вопрос.' }
    ],
