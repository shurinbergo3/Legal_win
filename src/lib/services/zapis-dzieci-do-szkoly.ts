...
const zapisDzieciDoSzkoly: ServiceEntry = {
  ru: {
    ...
    faq: [
      { q: 'Что такое klasa powitalna и кому она подходит?', a: 'Это адаптационный класс на 1 год для детей-иностранцев, не владеющих польским. До 15 учеников. Учат польский с native speaker (10 часов в неделю) + стандартные предметы. Цель — за год дать B1 уровень польского, чтобы перейти в обычный класс. Доступна с 1-го по 8-й класс. Подходит, если ребёнок приехал недавно или не учил польский.' },
      { q: 'Какая школа лучше — публичная или частная?', a: 'Публичная: бесплатно, обширная программа, до 28 учеников в классе. Достаточно качественная в крупных городах (Warszawa, Wrocław). Частная niepubliczna: 8 000–25 000 PLN/год, до 20 учеников, индивидуальный подход, часто лучшие педагоги. Międzynarodowa: 60 000–120 000 PLN/год, английская программа, IB, для возвращающихся в свою страну. Выбор — по бюджету и долгосрочным планам.' },
