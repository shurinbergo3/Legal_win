...
const ubezpieczenieOcAc: ServiceEntry = {
  ru: {
    ...
    subtitle: 'Подберём и оформим полис OC и AC - а если нет PESEL, сначала поможем его получить',
    lead: 'OC (ubezpieczenie odpowiedzialności cywilnej) - аналог ОСАГО и обязательна в Польше для каждого авто непрерывно, без единого дня разрыва. За отсутствие OC фонд UFG в 2026 году штрафует на 1 920-9 610 PLN, а при ДТП по вашей вине без полиса предъявит регресс - в среднем около 24 000 PLN. Главная проблема иностранца: чтобы оформить страховку, нужен PESEL - без него ни один страховщик договор не заключит и калькулятор цену не посчитает; скидки из Украины и Беларуси переносят не все страховщики, а при покупке б/у авто полис продавца действует лишь до конца его периода. Если PESEL ещё нет, мы сначала поможем его получить, затем подбираем выгодный тариф у нескольких страховщиков, оформляем OC/AC/NNW, переносим бонусы из-за рубежа и говорим по-русски.',
    facts: [
      ...
      { label: 'Нет PESEL?', value: 'Поможем', note: 'сначала оформим PESEL · потом полис' }
    ],
    grounds: {
      ...
      items: [
        ...
        { title: 'Нет PESEL - поможем оформить', desc: 'Чтобы застраховать авто в Польше, нужен PESEL: без него страховщик не заключит договор, а калькуляторы цену не покажут. Если PESEL ещё нет, сначала оформляем его, потом заключаем OC. Польские права для страхования самого авто не нужны.' },
    ...
    timeline: {
      ...
      steps: [
        { title: 'Консультация', duration: '20 мин', desc: 'Уточняем авто, стаж, статус (есть ли PESEL), наличие зарубежной истории. Если PESEL нет - планируем его оформление. Определяем нужный набор: OC, AC, NNW, Assistance.' },
        ...
        { title: 'Оформление полиса', duration: '30 мин', desc: 'Заключаем договор - онлайн или в офисе. Полис OC вступает в силу сразу. Оплата картой или переводом.' },
    ...
    documents: {
      ...
      items: [
        ...
        'PESEL - обязателен для страховки (если нет - поможем оформить)',
    ...
    faq: [
      { q: 'Нужен ли PESEL, чтобы застраховать авто?', a: 'Да. Для оформления OC в Польше нужен номер PESEL - без него страховщик не заключит договор, а онлайн-калькулятор не посчитает цену. Если PESEL у вас ещё нет, мы сначала поможем его получить, а затем оформим полис. Польские водительские права для страхования самого авто не нужны - страхуется машина, а не водитель.' },
    ...
    related: ['pesel', 'rejestracja-pojazdu', 'wymiana-prawa-jazdy', 'przeglad-techniczny'],
    ctaTitle: 'Оформим OC выгодно - поможем и с PESEL',
  ...
  pl: {
    ...
    subtitle: 'Dobierzemy i załatwimy polisę OC i AC - a jeśli nie masz numeru PESEL, najpierw pomożemy go wyrobić',
    lead: 'OC (ubezpieczenie odpowiedzialności cywilnej) jest w Polsce obowiązkowe dla każdego pojazdu w sposób ciągły, bez ani jednego dnia przerwy. Za brak OC Ubezpieczeniowy Fundusz Gwarancyjny (UFG) w 2026 r. nakłada karę od 1 920 do 9 610 PLN, a jeśli spowodujesz wypadek bez polisy - wystąpi z regresem, średnio około 24 000 PLN. Największy problem cudzoziemca: żeby zawrzeć ubezpieczenie, potrzebny jest numer PESEL - bez niego żaden ubezpieczyciel nie zawrze umowy, a kalkulator nie policzy ceny; nie wszyscy ubezpieczyciele przenoszą zniżki z Ukrainy czy Białorusi, a przy zakupie auta używanego polisa sprzedającego działa tylko do końca jego okresu. Jeśli nie masz jeszcze PESEL, najpierw pomożemy go wyrobić, potem dobieramy korzystną stawkę u kilku ubezpieczycieli, zawieramy OC/AC/NNW, przenosimy zniżki z zagranicy i obsługujemy klienta w jego języku.',
    facts: [
      ...
      { label: 'Nie masz PESEL?', value: 'Pomożemy', note: 'najpierw PESEL · potem polisa' }
    ],
    grounds: {
      ...
      items: [
        ...
        { title: 'Nie masz PESEL - pomożemy', desc: 'Żeby ubezpieczyć auto w Polsce, potrzebny jest PESEL: bez niego ubezpieczyciel nie zawrze umowy, a kalkulatory nie pokażą ceny. Jeśli nie masz go jeszcze, najpierw go wyrabiamy, potem zawieramy OC. Polskie prawo jazdy do ubezpieczenia samego auta nie jest potrzebne.' },
    ...
    timeline: {
      ...
      steps: [
        { title: 'Konsultacja', duration: '20 min', desc: 'Ustalamy auto, staż, status (czy masz PESEL), zagraniczną historię. Jeśli nie masz PESEL - planujemy jego wyrobienie. Określamy potrzebny zakres: OC, AC, NNW, Assistance.' },
        ...
        { title: 'Zawarcie polisy', duration: '30 min', desc: 'Zawieramy umowę - online lub w biurze. OC wchodzi w życie od razu. Płatność kartą lub przelewem.' },
    ...
    documents: {
      ...
      items: [
        ...
        'PESEL - wymagany do ubezpieczenia (jeśli nie masz - pomożemy wyrobić)',
    ...
    faq: [
      ...
      { q: 'Czy potrzebuję numeru PESEL, żeby ubezpieczyć auto?', a: 'Tak. Do zawarcia OC w Polsce potrzebny jest numer PESEL - bez niego ubezpieczyciel nie zawrze umowy, a kalkulator online nie policzy ceny. Jeśli nie masz jeszcze PESEL, najpierw pomożemy go wyrobić, a potem załatwimy polisę. Polskie prawo jazdy do ubezpieczenia samego auta nie jest potrzebne - ubezpiecza się pojazd, a nie kierowcę.' },
    ...
    related: ['pesel', 'rejestracja-pojazdu', 'wymiana-prawa-jazdy', 'przeglad-techniczny'],
    ctaTitle: 'Zawrzemy OC korzystnie - pomożemy też z PESEL',
  ...
  en: {
    ...
    subtitle: 'We compare and arrange OC and AC - and if you have no PESEL yet, we help you get one first',
    lead: 'OC (ubezpieczenie odpowiedzialności cywilnej - the compulsory third-party liability cover, the Polish equivalent of mandatory motor insurance) is required in Poland for every vehicle continuously, without a single day of gap. For driving without OC the guarantee fund UFG (Ubezpieczeniowy Fundusz Gwarancyjny) fines you 1 920-9 610 PLN in 2026, and if you cause an accident while uninsured it pursues you for recourse - on average around 24 000 PLN. The foreigner\'s core headache: to take out cover you need a PESEL number - without it no insurer will sign a contract and the calculators won\'t quote a price; not every insurer transfers no-claims discounts from Ukraine or Belarus; and when you buy a used car the seller\'s policy only runs to the end of his term. If you don\'t have a PESEL yet, we help you get one first, then compare the best rate across several insurers, sign OC/AC/NNW, transfer your overseas no-claims bonus and handle everything in your language.',
    facts: [
      ...
      { label: 'No PESEL yet?', value: 'We help', note: 'we get your PESEL first' }
    ],
    grounds: {
      ...
      items: [
        ...
        { title: 'No PESEL - we help you get one', desc: 'To insure a car in Poland you need a PESEL: without it an insurer won\'t sign a contract and the calculators won\'t show a price. If you don\'t have one yet, we get your PESEL first, then sign the OC. A Polish driving licence is not needed to insure the car itself.' },
    ...
    timeline: {
      ...
      steps: [
        { title: 'Consultation', duration: '20 min', desc: 'We confirm the car, your driving years, your status (whether you have a PESEL) and any overseas history. If you have no PESEL, we plan getting one. We settle the right set: OC, AC, NNW, Assistance.' },
        ...
        { title: 'Signing the policy', duration: '30 min', desc: 'We conclude the contract - online or in the office. OC takes effect immediately. Payment by card or transfer.' },
    ...
    documents: {
      ...
      items: [
        ...
        'PESEL - required for insurance (if you don\'t have one, we help you get it)',
    ...
    faq: [
      ...
      { q: 'Do I need a PESEL to insure a car in Poland?', a: 'Yes. To take out OC in Poland you need a PESEL number - without it an insurer won\'t sign a contract and the online calculator won\'t quote a price. If you don\'t have a PESEL yet, we help you get one first and then arrange the policy. A Polish driving licence is not needed to insure the car itself - it is the vehicle that is insured, not the driver.' },
    ...
    related: ['pesel', 'rejestracja-pojazdu', 'wymiana-prawa-jazdy', 'przeglad-techniczny'],
    ctaTitle: 'We will set up OC at a good rate - and help with your PESEL',
  ...
  tr: {
    ...
    subtitle: 'OC ve AC poliçesini karşılaştırıp yapıyoruz - PESEL numaranız yoksa önce onu almanıza yardım ederiz',
    lead: 'OC (ubezpieczenie odpowiedzialności cywilnej - zorunlu trafik sigortası) Polonya\'da her araç için kesintisiz, tek bir günlük boşluk olmadan zorunludur. OC eksikliğinde Sigorta Garanti Fonu UFG (Ubezpieczeniowy Fundusz Gwarancyjny) 2026\'da 1 920-9 610 PLN ceza keser; sigortasızken kazaya sebep olursanız rücu hakkını kullanır - ortalama yaklaşık 24 000 PLN. Yabancının asıl sorunu: sigorta yaptırmak için PESEL numarası gerekir - onsuz hiçbir sigortacı sözleşme yapmaz, hesaplayıcı da fiyat vermez; Ukrayna veya Belarus\'tan gelen hasarsızlık indirimlerini her sigortacı kabul etmez ve ikinci el araç alımında satıcının poliçesi yalnızca kendi dönemi sonuna kadar geçerlidir. PESEL numaranız henüz yoksa önce onu almanıza yardım eder, ardından birkaç sigortacıda en uygun tarifeyi karşılaştırır, OC/AC/NNW yapar, yurt dışı indirimlerini taşır ve sizinle kendi dilinizde ilgileniriz.',
    facts: [
      ...
      { label: 'PESEL yok mu?', value: 'Yardım ederiz', note: 'önce PESEL · sonra poliçe' }
    ],
    grounds: {
      ...
      items: [
        ...
        { title: 'PESEL yoksa - almanıza yardım ederiz', desc: 'Polonya\'da araç sigortalamak için PESEL gerekir: onsuz sigortacı sözleşme yapmaz, hesaplayıcılar da fiyat göstermez. Henüz yoksa önce PESEL alırız, sonra OC yaparız. Aracın kendisini sigortalamak için Polonya ehliyeti gerekmez.' },
    ...
    timeline: {
      ...
      steps: [
        { title: 'Danışmanlık', duration: '20 dk', desc: 'Aracı, sürüş geçmişini, statünüzü (PESEL var mı) ve yurt dışı geçmişini belirleriz. PESEL yoksa alınmasını planlarız. Gerekli kapsamı saptarız: OC, AC, NNW, Assistance.' },
        ...
        { title: 'Poliçenin yapılması', duration: '30 dk', desc: 'Sözleşmeyi yaparız - online veya ofiste. OC hemen yürürlüğe girer. Kart veya havaleyle ödeme.' },
    ...
    documents: {
      ...
      items: [
        ...
        'PESEL - sigorta için gerekli (yoksa almanıza yardım ederiz)',
    ...
    faq: [
      ...
      { q: 'Araç sigortası için PESEL gerekir mi?', a: 'Evet. Polonya\'da OC yaptırmak için PESEL numarası gerekir - onsuz sigortacı sözleşme yapmaz, online hesaplayıcı da fiyat vermez. PESEL numaranız henüz yoksa önce onu almanıza yardım eder, sonra poliçeyi yaparız. Aracın kendisini sigortalamak için Polonya ehliyeti gerekmez - sigortalanan araçtır, sürücü değil.' },
    ...
    related: ['pesel', 'rejestracja-pojazdu', 'wymiana-prawa-jazdy', 'przeglad-techniczny'],
    ctaTitle: 'OC\'yi uygun fiyata yapalım - PESEL\'de de yardımcı oluruz',
  ...
  uk: {
    ...
    subtitle: 'Підберемо й оформимо поліс OC і AC - а якщо немає PESEL, спершу допоможемо його отримати',
    lead: 'OC (ubezpieczenie odpowiedzialności cywilnej) - аналог ОСЦПВ і обов’язкове в Польщі для кожного авто безперервно, без жодного дня розриву. За відсутність OC фонд UFG у 2026 році штрафує на 1 920-9 610 PLN, а при ДТП з вашої вини без поліса висуне регрес - у середньому близько 24 000 PLN. Головна проблема іноземця: щоб оформити страховку, потрібен PESEL - без нього жоден страховик не укладе договір, а калькулятор не порахує ціну; знижки з України та Білорусі переносять не всі страховики, а при купівлі вживаного авто поліс продавця діє лише до кінця його періоду. Якщо PESEL ще немає, ми спершу допоможемо його отримати, потім підбираємо вигідний тариф у кількох страховиків, оформлюємо OC/AC/NNW, переносимо бонуси з-за кордону та говоримо українською.',
    facts: [
      ...
      { label: 'Немає PESEL?', value: 'Допоможемо', note: 'спершу PESEL · потім поліс' }
    ],
    grounds: {
      ...
      items: [
        ...
        { title: 'Немає PESEL - допоможемо оформити', desc: 'Щоб застрахувати авто в Польщі, потрібен PESEL: без нього страховик не укладе договір, а калькулятори не покажуть ціну. Якщо його ще немає, спершу оформлюємо PESEL, потім укладаємо OC. Польські права для страхування самого авто не потрібні.' },
    ...
    timeline: {
      ...
      steps: [
        { title: 'Консультація', duration: '20 хв', desc: 'Уточнюємо авто, стаж, статус (чи є PESEL), наявність закордонної історії. Якщо PESEL немає - плануємо його оформлення. Визначаємо потрібний набір: OC, AC, NNW, Assistance.' },
        ...
        { title: 'Оформлення поліса', duration: '30 хв', desc: 'Укладаємо договір - онлайн або в офісі. Поліс OC набуває чинності одразу. Оплата карткою або переказом.' },
    ...
    documents: {
      ...
      items: [
        ...
        'PESEL - обов’язковий для страхування (немає - допоможемо оформити)',
    ...
    faq: [
      ...
      { q: 'Чи потрібен PESEL, щоб застрахувати авто?', a: 'Так. Для оформлення OC у Польщі потрібен номер PESEL - без нього страховик не укладе договір, а онлайн-калькулятор не порахує ціну. Якщо PESEL у вас ще немає, ми спершу допоможемо його отримати, а потім оформимо поліс. Польські водійські права для страхування самого авто не потрібні - страхується машина, а не водій.' },
    ...
    related: ['pesel', 'rejestracja-pojazdu', 'wymiana-prawa-jazdy', 'przeglad-techniczny'],
    ctaTitle: 'Оформимо OC вигідно - допоможемо і з PESEL',
