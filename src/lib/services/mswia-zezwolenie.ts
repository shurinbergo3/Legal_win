...
const mswiaZezwolenie: ServiceEntry = {
  ru: {
    ...
    faq: [
      { q: 'Какие квартиры можно покупать без zezwolenia?', a: 'Любая lokal mieszkalny (квартира с księgą wieczystą lokalu) — без zezwolenia, для всех граждан мира. Но: только не в strefie nadgranicznej (15 км от границы Беларусь, Россия, Украина, Литва — там нужно zezwolenie всегда). И не дом с участком — это уже nieruchomość gruntowa, требует zezwolenia.' },
      { q: 'Как доказывать więź z Polską?', a: 'Документально. Несколько примеров сильных доказательств: 1) ВНЖ или Karta Polaka; 2) договор работы у польского работодателя 1+ год; 3) Sp. z o.o. в Польше с реальным оборотом; 4) брак с поляком (даже < 5 лет — частичная więź); 5) дети, которые ходят в польскую школу; 6) обучение в польском вузе; 7) Польские родственники — даже бабушки/дедушки. Чем больше — тем сильнее.' },
      { q: 'Что если получили odmowę?', a: '14 дней на wniosek o ponowne rozpatrzenie sprawy в Министерство. Если опять отказ — skarga в Wojewódzki Sąd Administracyjny (30 дней). Часто причина — слабая więź. Дополняем доказательства и подаём повторно. У нас 80%+ успеха при повторной подаче.' },
      { q: 'Можно ли купить через польскую Sp. z o.o.?', a: 'Да, и иногда это удобнее. Sp. z o.o. — польская юридическая личность, может покупать без zezwolenia (если 51%+ принадлежит резидентам ЕС или гражданам Польши). Для покупки домов через Sp. z o.o. с иностранным контролем (>50% non-EU) — снова нужно zezwolenie на покупку контрольного пакета.' },
      { q: 'Какова strefa nadgraniczna?', a: '15 км от государственной границы по карте. В Польше это границы с Беларусью, Россией (Калининградская область), Украиной и Литвой (только узкая полоса). В strefie — zezwolenie нужно ВСЕМ иностранцам, включая граждан ЕС. Большие города у границы (Białystok, Lublin, Rzeszów) — обычно вне strefy.' },
      { q: 'Сколько действует zezwolenie?', a: '2 года с даты wydania. На конкретную недвижимость (с указанием KW и адреса). Если не успели — продление за 30 дней до конца срока (1 раз). Если продали другую — нужно новое zezwolenie на новую.' },
      { q: 'Граждане ЕС/ЕЭП нужно zezwolenie?', a: 'Нет. Граждане UE и EOG (Norwegia, Islandia, Liechtenstein) + Швейцария — покупают без zezwolenia (с момента 2009/2014 после accesyjnych okresów dla rolnictwa). Только в strefie nadgranicznej могут быть ограничения.' }
    ],
