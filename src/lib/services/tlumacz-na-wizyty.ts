...
const tlumaczNaWizyty: ServiceEntry = {
  ru: {
    ...
    lead: 'Польский urzędnik не обязан говорить с вами на английском, а в банке POZ или USC — почти никто не говорит. LegalWin предоставляет юриста-переводчика, который не просто переводит, а понимает суть процедуры: знает, какие вопросы задаст ZUS-инспектор, какие документы потребует kierownik USC, как отвечать в сложной ситуации. Это сопровождение, а не buzzword «переводчик».',
    facts: [
    ...
    grounds: {
      ...
      subtitle: 'Юрист со знанием процедуры — не уличный переводчик. Это критическая разница в сложных делах.',
      items: [
        { title: 'Urząd Wojewódzki', desc: 'Подача TRC, ПМЖ, Karty Polaka, признания за гражданина. Сложная процедура — нужен юрист, не просто переводчик.' },
    ...
    timeline: {
      ...
      steps: [
        { title: 'Бронирование', duration: '5 мин', desc: 'Уточняете дату, время, urząd, цель визита. Получаете подтверждение и контакт юриста.' },
        { title: 'Подготовка', duration: '30–60 мин', desc: 'Юрист изучает вашу ситуацию: тип документа, основания, прошлые действия. Готовит список вопросов и документов.' },
        ...
        { title: 'Сопровождение в urzędzie', duration: '1–3 часа', desc: 'Юрист идёт с вами к окошку, переводит вопросы urzędnika, помогает заполнить формуляры, отвечает на uzupełnienia.' },
        { title: 'Документация результата', duration: '15 мин', desc: 'Получаете signed protocols / pisma / zaświadczenia. Юрист объясняет, что в них написано и какие следующие шаги.' },
    ...
    pricing: {
      ...
      items: [
        ...
        { label: 'Сопровождение в urząd', value: 'от 250 PLN/час', note: 'Минимум 2 часа · юрист-переводчик' },
    ...
    faq: [
      { q: 'Чем переводчик-юрист отличается от обычного устного переводчика?', a: 'Обычный переводчик переводит слова. Юрист-переводчик понимает процедуру: знает, какой ответ ожидает urzędnik, как минимизировать риск отказа, какие документы добавить. На сложных делах (TRC, naturalizacja, sąd) разница между «получили» и «получили отказ» — это юрист, а не переводчик.' },
      ...
      { q: 'Можно ли отправить юриста без меня?', a: 'Только если есть pełnomocnictwo. Подписать договор аренды, доверенность, забрать карту pobytu, открыть счёт — да, делаем по pełnomocnictwu. Личное присутствие требуется на свадьбе, биометрии TRC, экзамене на гражданство.' },
      ...
      { q: 'Что если визит отменили в день?', a: 'Если отмена — наша вина (юрист заболел, опаздывает) — возврат 100%. Если отмена с вашей стороны менее чем за 24 часа — оплата 50% брони. Если отмена urzędu (закрыт, нет связи) — переносим без доплаты.' },
      { q: 'Как выбираете юриста под мой случай?', a: 'У нас 12 юристов с разной специализацией. Иммиграционный — для TRC/ПМЖ. Корпоративный — для KRS/USC/Notar. Семейный — для брака/развода/детей. Уголовный — для sądu и prokuratury. Подбираем после brief в течение часа.' },
    ...
    ctaTitle: 'Юрист на urząd за 24 часа',
    ctaSubtitle: 'Бесплатная консультация: подбор юриста под визит, подготовка вопросов, brief по процедуре. Минимальная бронь — 2 часа.'
  },
  pl: {
    slug: 'tlumacz-na-wizyty',
    group: 'relocation',
    ...
    lead: 'Polski urzędnik nie musi mówić po angielsku, a w POZ czy USC niemal nikt nie mówi. LegalWin wysyła prawnika-tłumacza, który nie tylko tłumaczy, ale rozumie procedurę: wie, o co spyta inspektor ZUS, czego zażąda kierownik USC, jak odpowiadać w trudnej sytuacji. To asysta prawna, nie buzzword "tłumacz".',
    facts: [
    ...
    grounds: {
      ...
      subtitle: 'Prawnik znający procedurę — nie uliczny tłumacz. To krytyczne w trudnych sprawach.',
      items: [
        { title: 'Urząd Wojewódzki', desc: 'TRC, PR, Karta Polaka, uznanie za obywatela. Skomplikowane procedury wymagają prawnika.' },
    ...
    timeline: {
      ...
      steps: [
        { title: 'Rezerwacja', duration: '5 min', desc: 'Data, godz., urząd, cel. Potwierdzenie i kontakt do prawnika.' },
        { title: 'Przygotowanie', duration: '30–60 min', desc: 'Prawnik analizuje sprawę i przygotowuje listę pytań i dokumentów.' },
        { title: 'Spotkanie przed wizytą', duration: '15 min', desc: 'Przed urzędem — koordynacja: co mówić, co pokazywać, jakie mogą być pytania.' },
        { title: 'Asysta w urzędzie', duration: '1–3 h', desc: 'Prawnik przy okienku, tłumaczenie urzędnika, wypełnianie, odpowiedzi na uzupełnienia.' },
        { title: 'Dokumentacja', duration: '15 min', desc: 'Pisma / zaświadczenia. Prawnik tłumaczy treść i kolejne kroki.' },
    ...
    pricing: {
      ...
      items: [
        ...
        { label: 'Asysta w urzędzie', value: 'od 250 PLN/h', note: 'Min. 2 h · prawnik-tłumacz' },
    ...
    faq: [
      { q: 'Tłumacz-prawnik vs zwykły?', a: 'Zwykły tłumaczy słowa. Prawnik rozumie procedurę: zna oczekiwaną odpowiedź, minimalizuje ryzyko odmowy, dokłada dokumenty. W TRC, naturalizacji, sądzie — to różnica między "uzyskałem" a "odmówiono".' },
      ...
      { q: 'Czy prawnik może iść beze mnie?', a: 'Tylko z pełnomocnictwem. Najem, pełnomocnictwa, odbiór karty, konto — tak. Ślub, biometria TRC, egzamin obywatelstwa — osobiście.' },
      ...
      { q: 'Jak dobierany prawnik?', a: '12 prawników o różnej specjalizacji. Imigracyjny — TRC/PR. Korporacyjny — KRS/USC. Rodzinny — ślub/rozwód. Karny — sąd. Dobór po briefie w godzinę.' },
      { q: 'Zdalnie?', a: 'Częściowo. Video w banku, ePUAP, korespondencja — tak. Biometria, ślub, sąd — tylko osobiście. Zdalnie 50% stawki.' }
    ],
    related: ['pomoc-w-zatrudnieniu', 'zapis-dzieci-do-szkoly', 'tlumaczenia-przysiegle'],
    ctaTitle: 'Prawnik w urzędzie w 24 h',
    ctaSubtitle: 'Bezpłatna konsultacja: dobór prawnika, przygotowanie pytań, brief procedury. Minimum 2 h.'
  },
  en: {
    slug: 'tlumacz-na-wizyty',
    group: 'relocation',
    ...
    subtitle: 'Lawyer-interpreter for urząd, bank, school, hospital',
    ...
    grounds: {
      ...
      subtitle: 'A lawyer who knows the procedure — not a street interpreter. The difference matters in hard cases.',
      items: [
        { title: 'Voivodeship Office', desc: 'TRC, PR, Karta Polaka, citizenship recognition. Complex procedures need a lawyer.' },
    ...
    timeline: {
      ...
      steps: [
        { title: 'Booking', duration: '5 min', desc: 'Date, time, urząd, purpose. Confirmation and lawyer contact.' },
        { title: 'Preparation', duration: '30–60 min', desc: 'Lawyer reviews your case, prepares questions and document list.' },
        { title: 'Pre-visit briefing', duration: '15 min', desc: 'In a café outside the urząd — final coordination on what to say and show.' },
        { title: 'Urząd accompaniment', duration: '1–3 h', desc: 'Lawyer at the desk: translates the officer, fills forms, answers uzupełnienia.' },
        { title: 'Result documentation', duration: '15 min', desc: 'Signed protocols / pisma / zaświadczenia. Lawyer explains content and next steps.' },
    ...
    pricing: {
      ...
      items: [
        ...
        { label: 'Urząd accompaniment', value: 'from 250 PLN/h', note: 'Min 2 h · lawyer-interpreter' },
    ...
    faq: [
      { q: 'Lawyer-interpreter vs ordinary?', a: "An ordinary interpreter translates words. A lawyer-interpreter understands the procedure — knows the expected answer, minimises refusal risk, knows which extra documents to add. In TRC, naturalisation, court — that's the difference between 'received' and 'denied'." },
      ...
      { q: 'Can the lawyer go without me?', a: 'Only with a power of attorney. Tenancy, POAs, card collection, account opening — yes, we go solo. Wedding, TRC biometrics, citizenship exam — your presence required.' },
      ...
      { q: 'Lawyer selection?', a: '12 lawyers across specialities. Immigration — TRC/PR. Corporate — KRS/USC/notary. Family — wedding/divorce. Criminal — court/prosecutor. Picked within an hour after brief.' },
    ...
    related: ['pomoc-w-zatrudnieniu', 'zapis-dzieci-do-szkoly', 'tlumaczenia-przysiegle'],
    ctaTitle: 'Lawyer at urząd in 24 hours',
    ctaSubtitle: 'Free consultation: lawyer selection, question prep, procedure brief. Minimum booking — 2 hours.'
  }
};
