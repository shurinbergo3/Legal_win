...
const kartaStalegoPobytu: ServiceEntry = {
  ru: {
    ...
    lead: "Если вы из Украины, Беларуси, Казахстана или России и уже прожили в Польше 5 лет на временных картах - пора переходить на pobyt stały. Статус бессрочный, пластик меняется раз в 10 лет, а с Kartą Polaka можно зайти напрямую, минуя пятилетку.",
    facts: [
