...
const podatkiKsiegowosc: ServiceEntry = {
  ru: {
    ...
    faq: [
      ...
      { q: 'Налоговая проверка — что делать?', a: 'Не общайтесь с inspektorem без юриста. Получив zawiadomienie o kontroli, у вас есть 7 дней на подготовку. Делаем экспресс-аудит того, что проверяют, готовим документы, представляем интересы. При risiku negatywnej decyzji — заранее идём на porozumienie i wyjaśnienia. После: апелляция в Dyrektora Izby Administracji Skarbowej и WSA.' },
