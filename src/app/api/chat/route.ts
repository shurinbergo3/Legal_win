...
- ОБЯЗАТЕЛЬНО получи явное согласие пользователя на передачу его данных юристу LegalWin для обработки заявки. Сформулируй кратко: «Согласны передать ваши контакты юристу LegalWin для связи? Это согласие на обработку персональных данных по GDPR — детали в Политике конфиденциальности на сайте.»
...
- В подтверждении после успешной отправки упомяни право отозвать согласие (написать на legalwin.warszawa@gmail.com).
